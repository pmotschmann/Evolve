...
const fortressModules = {
  ...
  prtl_badlands: {
    ...
    sensor_drone: {
      ...
      effect() {
        ...
        let sci_bonus = global.race["cataclysm"]
          ...
          : `<div>${loc("space_moon_observatory_effect", [2])}</div><div>${loc("portal_sensor_drone_effect2", [2])}</div>`;
        let sci =
    ...
    minions: {
      ...
      cost: {
        Money(offset) {
          return spaceCostMultiplier("minions", offset, 150000, 1.22, "portal");
        },
        Furs(offset) {
          return spaceCostMultiplier("minions", offset, 35000, 1.22, "portal");
        },
        Infernite(offset) {
          return spaceCostMultiplier("minions", offset, 500, 1.22, "portal");
        },
        Orichalcum(offset) {
          return spaceCostMultiplier("minions", offset, 25000, 1.22, "portal");
        },
      },
      powered() {
        return 0;
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.minions.rank < 5
        ) {
    ...
    reaper: {
      ...
      cost: {
        Money(offset) {
          return spaceCostMultiplier("reaper", offset, 1200000, 1.2, "portal");
        },
        Furs(offset) {
          return spaceCostMultiplier("reaper", offset, 118000, 1.2, "portal");
        },
        Iron(offset) {
          return spaceCostMultiplier("reaper", offset, 340000, 1.2, "portal");
        },
        Soul_Gem(offset) {
    ...
    corpse_pile: {
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.corpse_pile.rank < 5
        ) {
          global.portal.throne.points--;
  ...
  prtl_wasteland: {
    ...
    throne: {
      ...
      effect(wiki) {
        ...
        if (global.race["absorbed"]) {
          let essense = global.race.absorbed
            .map((r) => races[r].name)
            .join(", ");
        ...
        if (global.portal["throne"] && global.portal.throne.hearts.length > 0) {
          let hearts = global.portal.throne.hearts
            .map((r) => races[r].name)
            .join(", ");
      ...
      action(args) {
        if (
          global.portal["throne"] &&
          global.portal.throne.hearts.length === 0 &&
          global.portal.throne.points > 0
        ) {
          global.portal.throne.skill = global.portal.throne.skill
            ? false
            : true;
          checkSkillPointAssignments();
          return true;
          ...
          if (!global.settings.portal.pit) {
            ...
            !global.tech["war_vault"] &&
            global.race?.absorbed?.length >= 13
          ) {
            ...
            !global.settings.portal.lake &&
            global.race?.absorbed?.length >= 33
          ) {
            ...
            global.race?.absorbed?.length >= 43 &&
            global.tech.hellspawn === 4
          ) {
    ...
    incinerator: {
      ...
      powered(wiki) {
        ...
        if (
          global.tech["hellspawn"] &&
          global.tech.hellspawn >= 7 &&
          global.portal["corpse_pile"]
        ) {
          power +=
            (0.75 + global.portal.corpse_pile.rank * 0.25) *
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.incinerator.rank < 5
        ) {
          global.portal.throne.points--;
    ...
    warehouse: {
      ...
      effect(wiki) {
        ...
        if (
          ...
          multiplier *=
            1 +
            (p_on["corruptor"] || 0) *
              (global.tech.asphodel >= 13 ? 0.16 : 0.12);
        }
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.warehouse.rank < 5
        ) {
          global.portal.throne.points--;
    ...
    hovel: {
      ...
      cost: {
        Money(offset) {
          return spaceCostMultiplier("hovel", offset, 145000, 1.3, "portal");
        },
        Stone(offset) {
          return spaceCostMultiplier("hovel", offset, 185000, 1.3, "portal");
        },
        Furs(offset) {
    ...
    hell_casino: {
      ...
      cost: {
        ...
        Furs(offset) {
          return spaceCostMultiplier(
            "hell_casino",
            offset,
            traitCostMod("untrustworthy", 175000),
            1.3,
            "portal",
          );
        },
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.hell_casino.rank < 5
        ) {
          global.portal.throne.points--;
    ...
    twisted_lab: {
      ...
      effect() {
        ...
        let know = global.race["absorbed"]
          ? global.race.absorbed.length * baseVal
          : baseVal;
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.twisted_lab.rank < 5
        ) {
          global.portal.throne.points--;
    ...
    demon_forge: {
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.demon_forge.rank < 5
        ) {
          global.portal.throne.points--;
    ...
    hell_factory: {
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.hell_factory.rank < 5
        ) {
          global.portal.throne.points--;
    ...
    pumpjack: {
      ...
      cost: {
        Money(offset) {
          return spaceCostMultiplier("pumpjack", offset, 295000, 1.3, "portal");
        },
        Cement(offset) {
          return spaceCostMultiplier("pumpjack", offset, 185000, 1.3, "portal");
        },
        Steel(offset) {
          return spaceCostMultiplier("pumpjack", offset, 275000, 1.3, "portal");
        },
      },
      effect() {
        ...
        if (
          global.race["blubber"] &&
          global.portal.hasOwnProperty("pumpjack")
        ) {
    ...
    dig_demon: {
      ...
      action(args) {
        if (
          ...
          global.portal.throne.skill &&
          global.portal.throne.points > 0 &&
          global.portal.dig_demon.rank < 5
        ) {
          global.portal.throne.points--;
      ...
      postPower(o) {
        ...
        global.resource[global.race.species].max = Math.max(
          0,
          global.resource[global.race.species].max + delta,
        );
        global.resource[global.race.species].amount = Math.max(
          0,
          global.resource[global.race.species].amount + delta,
        );
    ...
    tunneler: {
      ...
      cost: {
        Money(offset) {
          return spaceCostMultiplier("tunneler", offset, 275000, 1.3, "portal");
        },
        Food(offset) {
          return spaceCostMultiplier("tunneler", offset, 135000, 1.3, "portal");
        },
        Uranium(offset) {
    ...
    brute: {
      ...
      cost: {
        Money(offset) {
          return spaceCostMultiplier("brute", offset, 300000, 1.25, "portal");
        },
        Alloy(offset) {
          return spaceCostMultiplier("brute", offset, 238000, 1.25, "portal");
        },
        Bolognium(offset) {
          return spaceCostMultiplier("brute", offset, 65000, 1.25, "portal");
        },
        Mythril(offset) {
          return spaceCostMultiplier("brute", offset, 178000, 1.25, "portal");
        },
      },
      powered() {
        return 0;
  ...
  prtl_pit: {
        ...
        if (count >= 1) {
          ...
          if (global.tech.hell_pit >= 7 && num_s_attractor_on > 0) {
            cap *=
              ...
              global.stats.achieve.what_is_best.e >= 3
                ? 0.96
                : 0.97) ** num_s_attractor_on;
          }
          ...
          desc =
            desc +
            `<div>${loc("portal_soul_forge_effect2", [global.portal["soul_forge"] ? global.portal.soul_forge.kills.toLocaleString() : 0, Math.round(cap).toLocaleString()])}</div>`;
        }
    ...
    tavern: {
      ...
      cost: {
        ...
        Food(offset) {
          return spaceCostMultiplier("tavern", offset, 250000, 1.25, "portal");
        },
        Oil(offset) {
          return spaceCostMultiplier("tavern", offset, 125000, 1.25, "portal");
        },
        Brick(offset) {
          return spaceCostMultiplier("tavern", offset, 138000, 1.25, "portal");
        },
      },
      effect(wiki) {
        let desc = "";
  ...
  prtl_ruins: {
    info: {
      ...
      prop() {
        ...
        desc =
          desc +
          ` - <span class="has-text-advanced">${loc("portal_ruins_supressed")}:</span> <span class="has-text-caution">{{ on | filter('sup') }}</span>`;
        return desc;
      },
      filter(v, type) {
    ...
    war_vault: {
      ...
      cost: {
        Codex(offset) {
          return (offset || 0) +
            (global.portal.hasOwnProperty("war_vault")
              ? global.portal.war_vault.count
              : 0) ===
            0
            ? 1
            : 0;
      ...
      effect(wiki) {
        let count =
          ...
          (global.portal.hasOwnProperty("war_vault")
            ...
            : 0);
        return count < 1
          ? loc("portal_war_vault_effect", [100, global.resource.Soul_Gem.name])
          : loc("portal_war_vault_effect2");
      },
      action(args) {
        if (global.portal.war_vault.count < 1) {
          if (payCosts($(this)[0])) {
            ...
            if (global.portal.war_vault.count === 1) {
              ...
              messageQueue(
                loc("portal_war_vault_result", [global.resource.Soul_Gem.name]),
                "info",
                false,
                ["progress", "hell"],
              );
            ...
            messageQueue(
              loc("portal_war_vault_fail", [global.resource.Soul_Gem.name]),
              "info",
              false,
              ["progress", "hell"],
            );
    ...
    hell_forge: {
      ...
      effect(wiki) {
        ...
        let reactor = global.tech["inferno_power"]
          ? `<div>${loc("portal_hell_forge_effect2", [global.stats.achieve["what_is_best"] && global.stats.achieve.what_is_best.e >= 1 ? 12 : 10, loc(`portal_inferno_power_title`)])}</div>`
          : ``;
      ...
      powered(wiki) {
        ...
        if (infernal_forges_on) {
          power +=
            infernal_forges_on *
            (global.stats.achieve["what_is_best"] &&
            global.stats.achieve.what_is_best.e >= 1
              ? 12
              : 10);
        }
        return powerModifier(-power);
      ...
      effect(wiki) {
        ...
        if (
          ...
          multiplier *=
            1 +
            (p_on["corruptor"] || 0) *
              (global.tech?.asphodel >= 13 ? 0.12 : 0.1);
        }
        for (const res of $(this)[0].res()) {
          if (global.resource[res].display) {
            let val = sizeApproximation(
    ...
    oven: {
      ...
      desc(wiki) {
        if (
          ...
          return (
            `<div>${loc("portal_oven_title")}</div><div class="has-text-special">${loc("requires_segments", [100])}</div>` +
            (global.portal.hasOwnProperty("oven") &&
            global.portal.oven.count >= 100
  ...
  prtl_spire: {
    ...
    purifier: {
      ...
      powered() {
        return global.stats.achieve["what_is_best"] &&
          global.stats.achieve.what_is_best.e >= 2
          ? powerCostMod(100)
          : powerCostMod(125);
      },
      support() {
    ...
    sphinx: {
      ...
      desc() {
        return global.race["warlord"]
          ? loc("portal_sphinx_warlord_desc")
          : loc("portal_sphinx_desc");
      },
      reqs: { hell_spire: 6 },
      queue_complete() {
      ...
      effect(wiki) {
        ...
        if (count === 1) {
          ...
          return global.race["warlord"]
            ? loc("portal_sphinx_warlord_effect")
            : loc("portal_sphinx_effect3");
        }
    ...
    mechbay: {
      ...
      title() {
        return global.race["warlord"]
          ? loc("portal_demon_artificer_title")
          : loc("portal_mechbay_title");
      },
      desc() {
    ...
    spire: {
      ...
      effect() {
        ...
        let terrain = global.portal.hasOwnProperty("spire")
          ? `<span class="has-text-warning">${loc(`portal_spire_type_${global.portal.spire.type}`)}</span>`
          : "?";
        let status = ``;
        if (
          ...
          status = `<div>${loc("portal_spire_hazard", [
            Object.keys(global.portal.spire.status)
              .map(
                (v) =>
                  `<span class="has-text-warning">${loc(`portal_spire_status_${v}`)}</span>`,
              )
              .join(", "),
          ])}</div>`;
        }
        let progress = global.portal.hasOwnProperty("spire")
          ? `<span class="has-text-warning">${+global.portal.spire.progress.toFixed(3)}%</span>`
          : "0%";
      ...
      effect(wiki) {
        ...
        if (count >= 10) {
          let progress = global.portal.hasOwnProperty("waygate")
            ? `<span class="has-text-warning">${+global.portal.waygate.progress.toFixed(3)}%</span>`
            : "0%";
    ...
    bazaar: {
      ...
      cost: {
        ...
        Supply(offset) {
          return spaceCostMultiplier("bazaar", offset, 250000, 1.25, "portal");
        },
      },
      effect(wiki) {
        let vault = spatialReasoning(
          (bank_vault() * (global.portal?.spire?.count || 1)) / 3,
        );
        vault = +vault.toFixed(0);
...
export function renderFortress() {
  ...
  Object.keys(fortressModules).forEach(function (region) {
    ...
    if (global.settings.portal[`${show}`]) {
      ...
      if (
        typeof fortressModules[region].info["support"] &&
        global.portal[fortressModules[region].info["support"]]
      ) {
...
function buildEnemyFortress(parent) {
  ...
  let enemy =
    $(`<div v-for="(e, index) of enemy" :key="index" class="enemyFortress">
  ...
  vBind({
    ...
    methods: {
      attack(idx) {
        let horde = Math.floor(
          (global.portal.minions.spawns * seededRandom(6, 10, true)) / 10,
        );
        let scale = global.race["hivemind"] ? traits.hivemind.vars()[0] : 1;
        let rating = armyRating(scale, "hellArmy", 0) / scale;
        let died = seededRandom(
          (250 + global.portal.throne.enemy[idx].s * 250) / rating,
          (500 + global.portal.throne.enemy[idx].s * 1250) / rating,
          true,
        );
        ...
        for (let i = 0; i < range; i++) {
          died += seededRandom(
            (global.portal.throne.enemy[idx].s * 250) / rating,
            (global.portal.throne.enemy[idx].s * 1250) / rating,
            true,
          );
          if (horde > died) {
        ...
        if (global.portal.throne.enemy[idx].f <= 0) {
          messageQueue(
            loc("fortress_enemy_defeat", [
              races[global.portal.throne.enemy[idx].r].name,
            ]),
            "info",
            false,
            ["progress"],
...
export function buildFortress(parent, full) {
  ...
  if (full) {
    ...
    fort.append(
      `<div><h3 class="has-text-warning">${loc("portal_fortress_name")}</h3><button class="button observe right" @click="observation">${loc("hell_observation_button")}</button></div>`,
    );
  }
  ...
  let defense = $(
    `<span class="defense has-text-success" :aria-label="defense()">${loc("fortress_defense")} {{ f.garrison | defensive }}</span>`,
  );
  status.append(defense);
  let activity = $(
    `<span class="has-text-danger pad hostiles" :aria-label="hostiles()">${loc("fortress_spotted")} {{ f.threat }}</span>`,
  );
  ...
  wallStatus.append(
    $(
      `<span class="has-text-warning" :aria-label="defense()">${loc("fortress_wall")} <span :class="wall()">{{ f.walls }}%</span></span>`,
    ),
  );
  ...
  station.append(
    $(
      '<span tabindex="0" role="button" aria-label="remove soldiers from the fortress" class="sub has-text-danger" @click="aLast"><span>&laquo;</span></span>',
    ),
  );
  station.append(
  ...
  station.append(
    $(
      '<span tabindex="0" role="button" aria-label="add soldiers to the fortress" class="add has-text-success" @click="aNext"><span>&raquo;</span></span>',
    ),
  );
  ...
  station.append(
    $(
      '<span tabindex="0" role="button" aria-label="reduce number of patrols" class="sub has-text-danger" @click="patDec"><span>&laquo;</span></span>',
    ),
  );
  station.append($('<span class="current patLabel">{{ f.patrols }}</span>'));
  station.append(
    $(
      '<span tabindex="0" role="button" aria-label="increase number of patrols" class="add has-text-success" @click="patInc"><span>&raquo;</span></span>',
    ),
  );
  ...
  station.append(
    $(
      '<span tabindex="0" role="button" aria-label="reduce size of each patrol" class="sub has-text-danger" @click="patSizeDec"><span>&laquo;</span></span>',
    ),
  );
  station.append(
  ...
  station.append(
    $(
      '<span tabindex="0" role="button" aria-label="increase size of each patrol" class="add has-text-success" @click="patSizeInc"><span>&raquo;</span></span>',
    ),
  );

  station.append(
    $(
      `<span class="hireLabel"><button v-show="g.mercs" class="button merc" @click="hire" :aria-label="hireLabel()">${loc("civics_garrison_hire_mercenary")}</button></span>`,
    ),
  );
  ...
  bunks.append(
    $(
      `<span v-show="g.crew > 0"><span class="crew">${loc("civics_garrison_crew")}</span> <span>{{ g.crew }} | </span></span>`,
    ),
  );
  bunks.append(
    $(
      `<span><span class="wounded">${loc("civics_garrison_wounded")}</span> <span>{{ g.wounded }}</span></span>`,
    ),
  );
  ...
  reports.append(
    $(
      `<b-checkbox class="patrol" v-model="f.notify" true-value="Yes" false-value="No"${color}>${loc("fortress_patrol_reports")}</b-checkbox>`,
    ),
  );
  reports.append(
    $(
      `<b-checkbox class="patrol" v-model="f.s_ntfy" true-value="Yes" false-value="No"${color}>${loc("fortress_surv_reports")}</b-checkbox>`,
    ),
  );
  reports.append(
    $(
      `<b-checkbox class="patrol" v-model="f.nocrew"${color} v-show="s.showGalactic">${loc("fortress_nocrew")}</b-checkbox>`,
    ),
  );
  reports.append(
    $(
      `<b-checkbox class="patrol" v-model="f.safe_mode"${color}>${loc("fortress_safety_mode")}</b-checkbox>`,
    ),
  );
  reports.append(
    $(
      `<div class="patrol has-text-advanced">${loc("fortress_safety_mode_desc")}</div>`,
    ),
  );
  reports.append(
    $(
      `<div class="patrol reserveFloor"><span id="reserveFloorLabel">${loc("fortress_reserve_floor")}</span> <b-numberinput :input="clampReserveFloor()" min="0" :max="g.workers" v-model="f.reserve_floor" :controls="false" :disabled="!f.safe_mode" aria-labelledby="reserveFloorLabel"></b-numberinput></div>`,
    ),
  );
  reports.append(
    $(
      `<div class="patrol has-text-advanced">${loc("fortress_reserve_floor_desc")}</div>`,
    ),
  );
  ...
  if (full) {
    fort.append(
      $(
        `<div class="training"><span>${loc("civics_garrison_training")} - ${loc("arpa_to_complete")} {{ g.rate, g.progress | trainTime }}</span><button class="button observe right" @click="observation">${loc("hell_observation_button")}</button> <progress class="progress" :value="g.progress" max="100">{{ g.progress }}%</progress></div>`,
      ),
    );
  }
    ...
    methods: {
      ...
      aNext() {
        ...
        if (global.portal.fortress.garrison < global.civic.garrison.workers) {
          ...
          applyFortressSafetyLimits(false, 0);
      ...
      patInc() {
        let inc = keyMultiplier();
        let cap = global.portal.fortress.garrison;
        if (global.portal.fortress.safe_mode) {
          cap -= global.portal.fortress.reserve_floor;
          if (cap < 0) {
            cap = 0;
          }
        }
        if (
          ...
          if (
            ...
            global.portal.fortress.patrols = Math.floor(
              cap / global.portal.fortress.patrol_size,
            );
          }
          applyFortressSafetyLimits(false, 0);
        }
      ...
      patSizeInc() {
        ...
        if (global.portal.fortress.patrol_size < cap) {
      ...
      clampReserveFloor() {
        ensureFortressSafetySettings();
        if (global.portal.fortress.reserve_floor < 0) {
          global.portal.fortress.reserve_floor = 0;
        }
        if (
          global.portal.fortress.reserve_floor > global.civic.garrison.workers
        ) {
          global.portal.fortress.reserve_floor = global.civic.garrison.workers;
        }
        global.portal.fortress.reserve_floor = Math.floor(
          global.portal.fortress.reserve_floor,
        );
      },
      observation() {
        const hellObsModal = {
          template:
            '<div id="hellObsModal" class="modalBox hellObsModalBox"></div>',
        };
        this.$buefy.modal.open({
          parent: this,
          component: hellObsModal,
          ariaModal: true,
          ariaRole: "dialog",
          fullScreen: true,
        });
        const checkExist = setInterval(function () {
          if ($("#hellObsModal").length > 0) {
...
function ensureFortressSafetySettings() {
  if (!global.portal.hasOwnProperty("fortress")) {
    return;
  }
  if (!global.portal.fortress.hasOwnProperty("safe_mode")) {
    global.portal.fortress.safe_mode = false;
  }
  if (!global.portal.fortress.hasOwnProperty("reserve_floor")) {
    global.portal.fortress.reserve_floor = 25;
  }
  if (global.portal.fortress.reserve_floor < 0) {
    global.portal.fortress.reserve_floor = 0;
  }
...
function applyFortressSafetyLimits(announce, casualtyCount) {
  ensureFortressSafetySettings();
  ...
  let changed = false;
  let reserve = global.portal.fortress.reserve_floor;
  if (reserve > global.portal.fortress.garrison) {
    reserve = global.portal.fortress.garrison;
    global.portal.fortress.reserve_floor = reserve;
  }

  let available = global.portal.fortress.garrison - reserve;
  if (available < 0) {
    available = 0;
  }

  let spikeThreshold = Math.max(
    1,
    Math.ceil(global.portal.fortress.patrol_size / 2),
  );
  if (casualtyCount >= spikeThreshold && global.portal.fortress.patrols > 0) {
    let reduction = Math.max(1, Math.floor(casualtyCount / spikeThreshold));
    let reducedPatrols = Math.max(
      0,
      global.portal.fortress.patrols - reduction,
    );
    if (reducedPatrols !== global.portal.fortress.patrols) {
      global.portal.fortress.patrols = reducedPatrols;
      changed = true;
    }
  }

  if (global.portal.fortress.patrols > 0) {
    let maxPatrols = Math.floor(
      available / Math.max(1, global.portal.fortress.patrol_size),
    );
    if (global.portal.fortress.patrols > maxPatrols) {
      global.portal.fortress.patrols = Math.max(0, maxPatrols);
      changed = true;
    }
  }

  if (global.portal.fortress.patrols > 0) {
    let maxPatrolSize = Math.floor(available / global.portal.fortress.patrols);
    let boundedSize = Math.max(1, maxPatrolSize);
    if (global.portal.fortress.patrol_size > boundedSize) {
      global.portal.fortress.patrol_size = boundedSize;
      changed = true;
    }
  }

  if (changed && announce) {
    messageQueue(loc("fortress_safety_adjusted"), "info", false, ["hell"]);
  }
...
export function bloodwar() {
  ...
  if (dead > 0) {
    applyFortressSafetyLimits(true, dead);
  } else {
    applyFortressSafetyLimits(false, 0);
  }
...
export function hellguard() {
  if (
    ...
    if (
      (global.portal.throne.enemy.length === 0 ||
        (global.portal.throne.spawned.length >= 3 &&
          global.portal.throne.enemy.length <= 1) ||
        (global.portal.throne.spawned.length >= 8 &&
          global.portal.throne.enemy.length <= 2)) &&
      Math.rand(0, 10) === 0 &&
      global.portal.minions.spawns > 0
    ) {
      if (global.portal.throne.spawned.length === 0) {
        addHellEnemy(["basic"]);
      } else {
        if (
          global.portal.throne.spawned.length % 3 === 0 &&
          global.portal.throne.spawned.length % 5 === 0
        ) {
    ...
    if (global.portal.minions.on > 0) {
      ...
      global.portal.minions.spawns += Math.rand(
        global.portal.minions.on * low_spawn,
        global.portal.minions.on * spawn,
      );
    }
    ...
    if (global.portal.throne.enemy.length > 0) {
      ...
      global.portal.throne.enemy.forEach(function (e) {
        ...
        let reapEffect = global.race["blurry"]
          ? 102 - traits.blurry.vars()[0]
          : 102;
        ...
        let reaper =
          0.25 +
          eRating * 0.01 -
          (global.portal?.reaper?.count || 0) **
            (1 + ((global.portal?.reaper?.rank || 1) - 1) / 25) /
            reapEffect;
        if (reaper < 0.01) {
          reaper = 0.01;
        }
        let bound = Math.round(
          (global.portal.minions.spawns * (0.5 * eRating) * eRating ** reaper) /
            rating,
        );
        ...
        if (global.race["revive"]) {
          let revive = Math.round(
            Math.rand(0, kills / (traits.revive.vars()[6] * 20)),
          );
    ...
    if (
      ...
      if (global.portal["mortuary"] && global.portal["corpse_pile"]) {
        let corpse =
          (global.portal?.corpse_pile?.count || 0) * (p_on["mortuary"] || 0);
        if (corpse > 0) {
          souls *= 1 + corpse / 800;
        }
      }
  ...
  if (
    global.race["warlord"] &&
    global.resource.Authority.amount >= 250 &&
    global.resource.Authority.max >= 250
  ) {
  ...
  [
    ...
    if (
      global.portal[s] &&
      (!global.portal[s]["rank"] || global.portal[s].rank > 5)
    ) {
...
function rankDesc(label, struct) {
  return (global.portal[struct]?.rank || 1) <= 1
    ? label
    : `${label} (<span class="has-text-${global.portal[struct]?.rank === 5 ? "caution" : "info"}">${loc("wiki_trait_rank")} ${global.portal[struct]?.rank}</span>)`;
}
...
function addHellEnemy(type = [], allowRecursion = true, allowRepeat = false) {
  ...
  if (type.includes("basic")) {
    [
      ...
      if (
        allowRepeat ||
        (!global.portal.throne.spawned.includes(r) &&
          ![
            global.race.gods,
            global.race.old_gods,
            global.race.origin,
          ].includes(r))
      ) {
  ...
  if (invaders.length === 0 && allowRecursion) {
    ...
    messageQueue(
      loc("portal_invasion_msg", [races[race].entity]),
      "info",
      false,
      ["progress"],
    );
...
function checkBossResist(boss, weapon) {
  ...
  let seed_r1 = Math.floor(
    seededRandom(
      0,
      25000,
      false,
      seed + (global.portal?.spire?.count || 1) * 2,
    ),
  );
  let seed_w1 = Math.floor(
    seededRandom(0, 25000, false, seed + global.stats.reset * 2),
  );
  ...
  let resist =
    weaponList[Math.floor(seededRandom(0, weaponList.length, false, seed_r1))];
  let weak =
    weaponList[Math.floor(seededRandom(0, weaponList.length, false, seed_w1))];

  if (weapon === resist) {
    let seed_r2 = Math.floor(
      seededRandom(
        0,
        25000,
        false,
        seed_r1 + (global.portal?.spire?.count || 1) * 3,
      ),
    );
    ...
    let seed_w2 = Math.floor(
      seededRandom(0, 25000, false, seed_w1 + global.stats.reset * 3),
    );
...
export function drawMechLab() {
  ...
  if (global.portal.hasOwnProperty("mechbay") && global.settings.showMechLab) {
    ...
    let title = $(
      `<div><span class="has-text-caution">${loc(global.race["warlord"] ? `portal_mech_spawn` : `portal_mech_assembly`)}</span> - <span>{{ b.size | slabel }} {{ b.chassis | clabel }}</span></div>`,
    );
    assemble.append(title);

    title.append(
      ` | <span><span class="has-text-warning">${loc(global.race["warlord"] ? `portal_mech_lair_space` : "portal_mech_bay_space")}</span>: {{ m.bay }} / {{ m.max }}</span>`,
    );
    title.append(
      ` | <span><span class="has-text-warning">${loc("portal_mech_sup_avail")}</span>: {{ p.supply | round }} / {{ p.sup_max }}</span>`,
    );

    let infernal =
      global.blood["prepared"] && global.blood.prepared >= 3
        ? `<b-checkbox class="patrol" v-model="b.infernal">${loc("portal_mech_infernal")} (${loc("portal_mech_infernal_effect", [25])})</b-checkbox>`
        : ``;
    assemble.append(
      `<div><span class="has-text-warning">${loc(global.race["warlord"] ? `portal_mech_lair` : `portal_mech_space`)}</span> <span class="has-text-danger">{{ b.size | bay }}</span> | <span class="has-text-warning">${loc(`portal_mech_cost`)}</span> <span class="has-text-danger">{{ b.size | price }}</span> | <span class="has-text-warning">${loc(`portal_mech_soul`, [global.resource.Soul_Gem.name])}</span> <span class="has-text-danger">{{ b.size | soul }}</span>${infernal}</div>`,
    );
    ...
    let sizes = ``;
    let sizeTypes = global.race["warlord"]
      ? ["minion", "fiend", "cyberdemon", "archfiend"]
    ...
    for (let i = 0; i < 4; i++) {
      let weapons = ``;
      let weaponList = validWeapons(
        global.portal.mechbay.blueprint.size,
        global.portal.mechbay.blueprint.chassis,
        i,
      );
      ...
      options.append(`<b-dropdown :triggers="['hover', 'click']" aria-role="list" v-show="vis(${i})">
                <button class="button is-info" slot="trigger" aria-label="${loc(`portal_mech_weapon`)} ${i + 1}">
    ...
    for (let i = 0; i < e_cap; i++) {
      ...
      options.append(`<b-dropdown :triggers="['hover', 'click']" aria-role="list" v-show="eVis(${i})">
                <button class="button is-info" slot="trigger" aria-label="${loc(global.race["warlord"] ? `portal_mech_attribute` : `portal_mech_equipment`)} ${i + 1}">
    ...
    assemble.append(
      `<div class="mechAssemble"><button class="button is-info" slot="trigger" v-on:click="build()"><span>${global.race["warlord"] ? loc("portal_mech_summon") : loc("portal_mech_construct")}</span></button></div>`,
    );
    ...
    vBind({
      ...
      methods: {
        ...
        setSize(s) {
          ...
          if (global.race["warlord"]) {
            global.portal.mechbay.blueprint.equip[0] = validEquipment(
              s,
              global.portal.mechbay.blueprint.chassis,
            )[0];
          ...
          switch (s) {
            ...
            case "minion":
              if (global.blood["prepared"]) {
                global.portal.mechbay.blueprint.equip.push(
                  validEquipment(s, global.portal.mechbay.blueprint.chassis)[0],
                );
              }
            ...
            case "fiend":
              ...
              if (global.blood["prepared"]) {
                global.portal.mechbay.blueprint.equip.push(
                  validEquipment(s, global.portal.mechbay.blueprint.chassis)[1],
                );
              }
              global.portal.mechbay.blueprint.equip.length = global.blood[
                "prepared"
            ...
            case "archfiend":
              ...
              if (global.portal.mechbay.blueprint.equip.length < 3) {
                global.portal.mechbay.blueprint.equip.push(
                  validEquipment(s, global.portal.mechbay.blueprint.chassis)[2],
                );
              }
              if (global.portal.mechbay.blueprint.equip.length < 4) {
                global.portal.mechbay.blueprint.equip.push(
                  validEquipment(s, global.portal.mechbay.blueprint.chassis)[3],
                );
              }
              if (global.blood["prepared"]) {
                global.portal.mechbay.blueprint.equip.push(
                  validEquipment(s, global.portal.mechbay.blueprint.chassis)[4],
                );
              }
              global.portal.mechbay.blueprint.equip.length = global.blood[
                "prepared"
          ...
          if (global.race["warlord"]) {
            switch (s) {
              ...
              case "cyberdemon":
                ...
                global.portal.mechbay.blueprint.hardpoint[1] = validWeapons(
                  s,
                  global.portal.mechbay.blueprint.chassis,
                  1,
                )[1];
            ...
            global.portal.mechbay.blueprint.hardpoint[0] = validWeapons(
              s,
              global.portal.mechbay.blueprint.chassis,
              0,
            )[0];
        ...
        setType(c) {
          ...
          if (global.race["warlord"]) {
            ...
            if (c === "hydra") {
              ...
              global.portal.mechbay.blueprint.hardpoint[2] = validWeapons(
                global.portal.mechbay.blueprint.size,
                c,
                2,
              )[0];
              global.portal.mechbay.blueprint.hardpoint[3] = validWeapons(
                global.portal.mechbay.blueprint.size,
                c,
                3,
              )[0];
              ...
              c !== "hydra" &&
              global.portal.mechbay.blueprint.size === "archfiend"
            ) {
              global.portal.mechbay.blueprint.hardpoint.length = 2;
            }
            drawMechLab();
...
export function mechDesc(parent, obj) {
  ...
  var mechPattern = $(
    `<div class="divider">${mech.infernal ? `${loc("portal_mech_infernal")} ` : ""}${loc(`portal_mech_size_${mech.size}`)} ${loc(`portal_mech_chassis_${mech.chassis}`)}</div>`,
  );
  parent.append(desc);
  ...
  mech.hardpoint.forEach(function (hp) {
    weapons.push(
      `<span class="has-text-danger">${loc(`portal_mech_weapon_${hp}`)}</span>`,
    );
  });
  ...
  mech.equip.forEach(function (eq) {
    ...
    equip.push(
      `<span class="has-text-warning">${loc(`portal_mech_equip_${type}`)}</span>`,
    );
  });
      ...
      case "archfiend":
        if (point === undefined || point === false) {
          ...
          switch (type) {
            case "dragon":
              weaponList =
                point === 0 ? ["claws"] : ["cold", "shock", "fire", "acid"];
              break;
            case "snake":
              weaponList =
                point === 0 ? ["venom"] : ["cold", "shock", "fire", "acid"];
              break;
            case "gorgon":
              weaponList =
                point === 0
...
function drawMechs() {
  ...
  list.append(`
      <div v-for="(mech, index) of mechs" :key="index" class="mechRow" :class="index < active ? '' : 'inactive-row' ">
        <a class="scrap" @click="scrap(index)" role="button" tabindex="0" :aria-label="'${loc(global.race["warlord"] ? "portal_mech_unsummon" : "portal_mech_scrap")} #' + (index + 1)">${loc(global.race["warlord"] ? "portal_mech_unsummon" : "portal_mech_scrap")}</a>
        ...
        <div :class="'gearList '+mech.size">
          <div>
            <template v-for="hp of mech.hardpoint">
              <span> | </span>
              <span class="is-sr-only">${loc(`portal_mech_weapon`)}:</span>
        ...
        <div :class="'gearList '+mech.size">
          <div>
            <template v-for="eq of mech.equip">
              <span> | </span>
              <span class="is-sr-only">${loc(global.race["warlord"] ? `portal_mech_attribute` : `portal_mech_equipment`)}:</span>
...
function weaponPower(mech, power) {
  ...
  if (
    mech.equip.includes("special") &&
    (mech.size === "large" || mech.size === "cyberdemon")
  ) {
    power *= 1.02;
  }
  return power;
...
function statusEffect(mech, effect) {
  ...
  switch (effect) {
    ...
    case "hilly":
      {
        if (
          !["spider", "flying_imp", "harpy", "dragon"].includes(mech.chassis)
        ) {
          rating = 0.75;
        }
      }
    ...
    case "mountain":
      {
        if (mech.chassis !== "spider" && !mech.equip.includes("grapple")) {
          rating =
            mech.equip.includes("flare") || mech.equip.includes("echo")
              ? 0.75
              : 0.5;
        }
      }
    ...
    case "radioactive":
      {
        if (
          ...
          !mech.equip.includes("manashield")
        ) {
          rating = 0.5;
        }
      }
    ...
    case "river":
      {
        if (
          !["hover", "flying_imp", "harpy", "dragon"].includes(mech.chassis)
        ) {
          rating = 0.65;
        }
      }
    ...
    case "chasm":
      {
        if (
          !mech.equip.includes("grapple") &&
          !["flying_imp", "harpy", "dragon"].includes(mech.chassis)
        ) {
    ...
    case "dark":
      {
        if (
          ...
          !mech.equip.includes("darkvision")
        ) {
    ...
    rating +=
      ...
      Math.floor(
        seededRandom(
          ...
          10,
          false,
          global.stats.reset + (global.portal?.spire?.count || 1) * 42,
        ),
      );
    if (rating > 1) {
      rating = 1;
    ...
    case "hound":
      {
        switch (terrain) {
          case "sand":
            terrainFactor = ["small", "medium", "minion", "fiend"].includes(
              mech.size,
            )
              ? 0.9
              : 0.85;
...
export function drawHellObservations() {
  let info = $("#hellObsModal");
  clearElement(info);
  ...
  observe.append(`<b-tabs id="hellTabs" class="resTabs" v-model="s.hellTabs" :animated="s.animated" @input="swapTab">
        <b-tab-item id="h_Report">
            <template slot="header">
                <h2 class="is-sr-only">${loc("hell_tabs_reports")}</h2>
                <span aria-hidden="true">${loc("hell_tabs_reports")}</span>
            </template>
        </b-tab-item>
        <b-tab-item id="h_Analysis">
            <template slot="header">
                <h2 class="is-sr-only">${loc("hell_tabs_analysis")}</h2>
                <span aria-hidden="true">${loc("hell_tabs_analysis")}</span>
            </template>
        </b-tab-item>
    </b-tabs>`);
...
function drawHellAnalysis() {
  ...
  let drawStats = function (id, type) {
    ...
    elem.append(`
            <div><h2 class="has-text-warning">${loc("hell_analysis_" + type)}</h2>${type === "period" ? '<button id="resetHellObservation" class="text-button has-text-danger" @click="resetObservations()">{{ | resetLabel }}</button>' : ""}</div>
            <div><h2 class="has-text-alert">{{ st.${type}.start | startLabel }}</h2></div>
            <div><h2>{{ st.${type}.days, s.display | time }}</h2></div>
            <div><h2>{{ st.${type}.kills, 'kills', s.average | genericMulti }}</h2><button class="text-button has-text-advanced" aria-label="${loc("hell_analysis_toggle_bd", [loc("hell_analysis_toggle_bd_kills")])}" @click="toggleDropdown('dropKills')">{{ s.dropKills | dropdownLabel }}</button></div>
            ...
            <div v-show="sg.display"><h2>{{ st.${type}.gems, 'gems', s.average | genericMulti }}</h2><button class="text-button has-text-advanced" aria-label="${loc("hell_analysis_toggle_bd", [global.resource.Soul_Gem.name])}" @click="toggleDropdown('dropGems')">{{ s.dropGems | dropdownLabel }}</button></div>
    ...
    vBind({
      ...
      methods: {
        resetObservations() {
          Object.keys(global.portal.observe.stats.period).forEach(
            function (stat) {
              if (["kills", "gems"].includes(stat)) {
  ...
  stats.append(graphs);
  graphs.append(
    `<div><button id="hellGraphCreator" class="text-button has-text-success" @click="createGraph()">${loc("hell_graph_create")}</button></div>`,
  );
      ...
      createGraph() {
        ...
        let checkExist = setInterval(function () {
          if ($("#modalBox").length > 0) {
            ...
            $("#modalBox").append(
              $(
                `<p id="modalBoxTitle" class="has-text-warning modalTitle">${loc("hell_graph_title")}</p>`,
              ),
            );
            ...
            dataRegion.append(
              `<div><h2 class="has-text-warning">${loc("hell_graph_data")}</h2></div>`,
            );
            Object.keys(global.portal.observe.stats).forEach(
              function (dataSet) {
...
function drawGraph(info, graphInfo) {
  ...
  chartCont.append(`<div id="graph-${id}-controls" class="graphControls">
        <div>
            <h2></h2>
            <button class="text-button has-text-danger" @click="deleteGraph()">Delete</button>
        </div>
...
function drawHellReports() {
  ...
  reportListSection.append(`<div id="hellReportLogTitle"><h2 class="has-text-info">${loc("hell_report_log")}</h2><span tabindex="0" role="button" class="refresh" @click="updateList()" aria-label="${loc("hell_report_log_refresh_aria")}">
  ...
  let updateList = function (startYear, startDay) {
    ...
    for (startYear; startYear < global.city.calendar.year; startYear++) {
      for (startDay; startDay <= orbitLength(); startDay++) {
        ...
        list =
          `
                    <div class="text-button"><span tabindex="0" role="button" aria-label="${loc(`hell_report_log_load_aria`, [loc("year"), startYear, loc("day"), startDay])}" @click="reportLoad('${startYear}','${startDay}')">${loc("year") + " " + startYear + " | " + loc("day") + " " + startDay}${gemString}</span></div>
                ` + list;
      }
      startDay = 1;
    }
  ...
  let loadReport = function (year, day) {
    ...
    statsBar.append(
      `<div><h2 class="has-text-info">${loc("hell_report_log_stats", [year, day])}</h2></div>`,
    );
    statsBar.append(`<div>
    ...
    info.append(
      `<div><h2 class="has-text-info">${loc("hell_report_log_report", [year, day])}</h2></div>`,
    );
    info.append(
      `<p class="has-text-danger">${loc("hell_report_log_start", [curr_report.start])}</p>`,
    );

    if (curr_report.soul_attractors) {
      info.append(
        `<p>${loc("hell_report_log_soul_attractors", [curr_report.soul_attractors])}</p>`,
      );
    }
    if (curr_report.ghost_trappers) {
      info.append(
        `<p>${loc("hell_report_log_ghost_trappers", [curr_report.ghost_trappers])}</p>`,
      );
    }
    if (curr_report.soul_forge) {
      let displayText = $(`<p></p>`);
      displayText.append(
        `<span>${loc("hell_report_log_soul_forge", [curr_report.soul_forge.kills])}</span>`,
      );
      if (curr_report.soul_forge.gem) {
        displayText.append(
          `<span class="has-text-success">${loc("hell_report_log_soul_find", [global.resource.Soul_Gem.name, 1])}</span>`,
        );
      }
      if (curr_report.soul_forge.gem_craft) {
        displayText.append(
          `<span class="has-text-success">${loc("hell_report_log_soul_craft", [curr_report.soul_forge.corrupt ? loc("resource_Corrupt_Gem_name") : global.resource.Soul_Gem.name])}</span>`,
        );
      }
    ...
    if (curr_report.stats.gems.compactor) {
      ...
      if (curr_report.stats.gems.compactor) {
        displayText.append(
          `<span class="has-text-success">${loc("hell_report_log_compactor", [curr_report.stats.gems.compactor, global.resource.Soul_Gem.name])}</span>`,
        );
      }
      info.append(displayText);
    }
    ...
    if (curr_report.drones) {
      Object.keys(curr_report.drones).forEach(function (num) {
        ...
        if (drone.encounter) {
          ...
          info.append(
            `<p class="has-text-warning">${loc("hell_report_log_encounter_fail", [name])}</p>`,
          );
        }
      });
    }
    if (curr_report.patrols) {
      Object.keys(curr_report.patrols).forEach(function (num) {
        ...
        if (patrol.encounter) {
          ...
          if (patrol.ambush) {
            displayText.append(
              `<span class="has-text-warning">${loc("hell_report_log_patrol_ambush", [name, patrol.kills])}</span>`,
            );
          } else {
            displayText.append(
              `<span>${loc("hell_report_log_encounter", [name, patrol.kills])}</span>`,
            );
          }
          if (patrol.wounded) {
            displayText.append(
              `<span class="has-text-danger">${patrol.wounded > 1 ? loc("hell_report_log_patrol_wounded_plural", [patrol.wounded]) : loc("hell_report_log_patrol_wounded")}</span>`,
            );
          }
          if (patrol.died) {
            displayText.append(
              `<span class="has-text-danger">${patrol.died > 1 ? loc("hell_report_log_patrol_killed_plural", [patrol.died]) : loc("hell_report_log_patrol_killed")}</span>`,
            );
          }
          if (patrol.gem > 0) {
            displayText.append(
              `<span class="has-text-success">${loc("hell_report_log_soul_find", [global.resource.Soul_Gem.name, patrol.gem])}</span>`,
            );
          }
          info.append(displayText);
        } else {
    ...
    if (curr_report.surveyor_finds) {
      Object.keys(curr_report.surveyor_finds).forEach(function (num) {
        ...
        let name = loc("hell_report_log_obj_counter", [
          jobName("hell_surveyor"),
          num,
        ]);

        let displayText = $(`<p></p>`);
        displayText.append(
          `<span>${loc("hell_report_log_search", [name, surveyor.bodies])}</span>`,
        );
        if (surveyor.gem > 0) {
          displayText.append(
            `<span class="has-text-success">${loc("hell_report_log_soul_search", [global.resource.Soul_Gem.name, surveyor.gem])}</span>`,
          );
        }
        info.append(displayText);
      });
    ...
    if (curr_report.revived) {
      info.append(
        `<p>${curr_report.revived > 1 ? loc("hell_report_log_revived_plural", [curr_report.revived]) : loc("hell_report_log_revived")}</p>`,
      );
    }
    if (curr_report.patrols_lost) {
      info.append(
        `<p class="has-text-danger">${loc("hell_report_log_patrols_lost", [curr_report.patrols_lost])}</p>`,
      );
    }
    if (curr_report.siege) {
      if (curr_report.siege.destroyed) {
        info.append(
          `<p class="has-text-danger">${loc("hell_report_log_siege", [curr_report.siege.surveyors, curr_report.siege.soldiers, curr_report.siege.kills])}</p>`,
        );
      } else {
        info.append(
          `<p class="has-text-warning">${loc("hell_report_log_siege_fail", [curr_report.siege.damage, curr_report.siege.kills])}</p>`,
        );
      }
    }
    if (curr_report.demons) {
      info.append(
        `<p class="has-text-danger">${loc("hell_report_log_demons", [curr_report.demons])}</p>`,
      );
    }
    if (curr_report.surveyors) {
      info.append(
        `<p class="has-text-danger">${curr_report.surveyors > 1 ? loc("hell_report_log_surveyors_plural", [curr_report.surveyors]) : loc("hell_report_log_surveyors")}</p>`,
      );
    }
    if (curr_report.gun_emplacements) {
      Object.keys(curr_report.gun_emplacements).forEach(function (num) {
        ...
        displayText.append(
          $(
            `<span>${loc("hell_report_log_misc_kills", [name, gun.kills, loc("portal_pit_name")])}</span>`,
          ),
        );
        if (gun.gem) {
          displayText.append(
    ...
    if (curr_report.gate_turrets) {
      Object.keys(curr_report.gate_turrets).forEach(function (num) {
        ...
        displayText.append(
          `<span>${loc("hell_report_log_misc_kills", [name, turret.kills, loc("portal_gate_name")])}</span>`,
        );
        if (turret.gem) {
          displayText.append(
            `<span class="has-text-success">${loc("hell_report_log_soul_find", [global.resource.Soul_Gem.name, 1])}</span>`,
