    ...
    $('body').append(`<div id="topBar" class="topBar">
        ...
        <span class="calendar">
            ...
            <span v-show="city.calendar.day">
                <b-tooltip :label="sign()" :aria-label="sign()" position="is-bottom" size="is-small" class="astro" multilined animated><span id="astroSign" v-html="getAstroSign()"></span></b-tooltip>
