    ...
    switch (type){
        case 'power':
            power_structs = [
                ...
                'eden_elysium:sacred_smelter','prtl_pit:soul_capacitor','prtl_lake:oven_complete','eden_elysium:elysanite_mine','eden_elysium:elerium_containment','eden_elysium:pillbox','city:replicator'
            ];
            break;
        case 'moon':
