    ...
    switch (type){
        case 'power':
            power_structs = [
                ...
                'int_alpha:starport','eden_asphodel:encampment','tau_gas:gas_shipyard','tau_gas2:adv_shipyard','spc_dwarf:shipyard','spc_dwarf:repair_yard','spc_titan:ai_core2','spc_eris:drone_control','spc_titan:ai_colonist','int_blackhole:s_gate','gxy_gateway:starbase','spc_triton:fob',
                'prtl_wasteland:demon_forge','prtl_wasteland:twisted_lab','spc_enceladus:operating_base','spc_enceladus:zero_g_lab','spc_venus:descender','spc_titan:sam','city:detector','spc_red:detector_red','spc_hell:detector_hell','spc_dwarf:detector_dwarf','spc_dwarf:alien_containment',
                'spc_gas:sector_command','gxy_gateway:ship_dock','prtl_ruins:hell_forge','int_neutron:stellar_forge','int_neutron:citadel',
                ...
                'int_sirius:ascension_trigger','spc_makemake:orichalcum_mine','spc_makemake:elerium_mine','spc_makemake:uranium_mine','spc_makemake:neutronium_mine','spc_survey:mineshaft','spc_hell:mercury_mine','spc_dwarf:m_relay','tau_gas:gas_relay','tau_gas2:tcm_relay',
