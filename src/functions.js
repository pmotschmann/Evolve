...
export function powerGrid(type,reset){
    ...
    switch (type){
        case 'power':
            power_structs = [
                'prtl_ruins:arcology','city:apartment','int_alpha:habitat','int_alpha:luxury_condo','spc_red:spaceport','int_alpha:starport','spc_dwarf:shipyard','int_blackhole:s_gate','gxy_gateway:starbase',
