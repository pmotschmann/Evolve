    ...
    switch (type){
        case 'power':
            power_structs = [
                ...
                'prtl_wasteland:demon_forge','spc_enceladus:operating_base','spc_enceladus:zero_g_lab','spc_titan:sam','gxy_gateway:ship_dock','prtl_ruins:hell_forge','int_neutron:stellar_forge','int_neutron:citadel',
