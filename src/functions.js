...
export function powerGrid(type,reset){
    ...
    switch (type){
        ...
        case 'tau_roid':
            ...
            break;
        case 'asphodel':
            power_structs = ['eden_asphodel:soul_engine','eden_asphodel:bunker','eden_asphodel:asphodel_harvester','eden_asphodel:ectoplasm_processor','eden_asphodel:research_station'];
            break;
    }
