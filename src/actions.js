...
export const actions = {
  evolution: {
    rna: {
      ...
      condition() {
        return (
          global.resource.hasOwnProperty("RNA") &&
          global.resource.RNA.display &&
          !global.race["evoFinalMenu"]
        );
      },
      action(args) {
    ...
    dna: {
      ...
      condition() {
        return (
          global.resource.hasOwnProperty("DNA") &&
          global.resource.DNA.display &&
    ...
    membrane: {
      ...
      condition() {
        return (
          global.evolution.hasOwnProperty("membrane") &&
          !global.race["evoFinalMenu"]
        );
      },
      cost: {
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          global["resource"]["RNA"].max += global.evolution["mitochondria"]
            ? global.evolution["mitochondria"].count * 5 + 5
            : 5;
    ...
    organelles: {
      ...
      condition() {
        return (
          global.evolution.hasOwnProperty("organelles") &&
          !global.race["evoFinalMenu"]
        );
      },
      cost: {
    ...
    nucleus: {
      ...
      condition() {
        return (
          global.evolution.hasOwnProperty("nucleus") &&
          !global.race["evoFinalMenu"]
        );
      },
      cost: {
        RNA(offset) {
          return evolveCosts(
            "nucleus",
            38,
            global.tech["evo"] && global.tech.evo >= 4 ? 16 : 32,
            offset,
          );
        },
        DNA(offset) {
          return evolveCosts(
            "nucleus",
            18,
            global.tech["evo"] && global.tech.evo >= 4 ? 12 : 16,
            offset,
          );
        },
      },
    ...
    eukaryotic_cell: {
      ...
      condition() {
        return (
          global.evolution.hasOwnProperty("eukaryotic_cell") &&
          !global.race["evoFinalMenu"]
        );
      },
      cost: {
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          global["resource"]["DNA"].max += global.evolution["mitochondria"]
            ? global.evolution["mitochondria"].count * 10 + 10
            : 10;
          return true;
        }
    ...
    mitochondria: {
      ...
      condition() {
        return (
          global.evolution.hasOwnProperty("mitochondria") &&
          !global.race["evoFinalMenu"]
        );
      },
      cost: {
    ...
    chloroplasts: {
      ...
      title() {
        return global.evolution["gselect"]
          ? loc("genelab_genus_plant")
          : loc("evo_chloroplasts_title");
      },
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_chloroplasts_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_chloroplasts_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    chitin: {
      ...
      title() {
        return global.evolution["gselect"]
          ? loc("genelab_genus_fungi")
          : loc("evo_chitin_title");
      },
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_chitin_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_chitin_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
          if (global.evolution["gselect"]) {
    ...
    exterminate: {
      ...
      title() {
        return global.evolution["gselect"]
          ? loc("genelab_genus_synthetic")
          : loc("evo_exterminate_title");
      },
      ...
      condition() {
        return (
          genus_condition(2) &&
          global.stats.achieve["obsolete"] &&
          global.stats.achieve.obsolete.l >= 5
        );
      },
      cost: {
        DNA() {
    ...
    bryophyte: {
      ...
      condition() {
        let allowed =
          global.tech["evo_plant"] || global.tech["evo_fungi"] ? true : false;
    ...
    athropods: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_athropods_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_athropods_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    humanoid: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_humanoid_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_humanoid_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    gigantism: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_gigantism_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_gigantism_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    dwarfism: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_dwarfism_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_dwarfism_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    animalism: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_animalism_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_animalism_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    carnivore: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_carnivore_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_carnivore_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
          global.tech["evo"] = 7;
    ...
    herbivore: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_herbivore_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_herbivore_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
          global.tech["evo"] = 7;
    ...
    omnivore: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_omnivore_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_omnivore_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    celestial: {
      ...
      condition() {
        let allowed =
          ...
          (global.blood["unbound"] && global.blood.unbound >= 3)
            ? true
            : false;
    ...
    demonic: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe === "evil"
          ? `<div>${loc("evo_demonic_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_demonic_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    eldritch: {
      ...
      condition() {
        let allowed =
          global.stats.achieve["nightmare"] &&
    ...
    aquatic: {
      ...
      condition() {
        let allowed =
          ["oceanic", "swamp"].includes(global.city.biome) ||
          global.blood["unbound"]
            ? true
            : false;
        return allowed && genus_condition(5);
      },
    ...
    heat: {
      ...
      condition() {
        let allowed =
          ["volcanic", "ashland"].includes(global.city.biome) ||
          global.blood["unbound"]
            ? true
            : false;
        return allowed && genus_condition(5);
    ...
    sand: {
      ...
      condition() {
        let allowed =
          ["desert", "ashland"].includes(global.city.biome) ||
          global.blood["unbound"]
            ? true
            : false;
        return allowed && genus_condition(5);
    ...
    eggshell: {
      ...
      effect() {
        return global.city.biome === "hellscape" &&
          global.race.universe !== "evil"
          ? `<div>${loc("evo_eggshell_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
          : loc("evo_eggshell_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    endothermic: {
      ...
      title() {
        return global.evolution["gselect"]
          ? loc("genelab_genus_avian")
          : loc("evo_endothermic_title");
      },
    ...
    ectothermic: {
      ...
      title() {
        return global.evolution["gselect"]
          ? loc("genelab_genus_reptilian")
          : loc("evo_ectothermic_title");
      },
    ...
    sentience: {
      ...
      effect() {
        return global.evolution["exterminate"]
          ? loc("evo_sentience_ai_effect")
          : loc("evo_sentience_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          for (let genus in genus_def) {
            if (
              global.tech[`evo_${genus}`] &&
              global.tech[`evo_${genus}`] >= 2
            ) {
              type = genus;
              break;
            }
          ...
          if (
            global.race["junker"] ||
            global.race["sludge"] ||
            global.race["ultra_sludge"]
          ) {
            let race = global.race["sludge"]
              ? "sludge"
              : global.race["ultra_sludge"]
                ? "ultra_sludge"
                : "junker";
          ...
          global.race.species =
            allowed[Math.floor(seededRandom(0, allowed.length))];
          if (
            global.stats.achieve[`extinct_${global.race.species}`] &&
            global.stats.achieve[`extinct_${global.race.species}`].l >= 1
          ) {
            global.race.species =
              allowed[Math.floor(seededRandom(0, allowed.length))];
          }
      ...
      emblem() {
        for (let idx in raceList) {
          let id = raceList[idx];
          if (
            global.tech[`evo_${races[id].type}`] &&
            global.tech[`evo_${races[id].type}`] >= 2
          ) {
  ...
  city: {
    gift: {
      ...
      condition() {
        ...
        if (
          date.getMonth() !== 11 ||
          (date.getMonth() === 11 &&
            (date.getDate() <= 16 || date.getDate() >= 25))
        ) {
          ...
          if (
            ...
            if (active_gift === `g2019`) {
              if (global["special"] && global.special["gift"]) {
                ...
                if (global.race.universe === "antimatter") {
                  ...
                  messageQueue(
                    loc("city_gift_msg", [
                      100,
                      loc("arpa_genepool_effect_antiplasmid"),
                    ]),
                    "info",
                    false,
                    ["events"],
                  ...
                  messageQueue(
                    loc("city_gift_msg", [
                      100,
                      loc("arpa_genepool_effect_plasmid"),
                    ]),
                    "info",
                    false,
                    ["events"],
              ...
              if (global["special"] && global.special["gift"]) {
                ...
                let resets = global.stats.hasOwnProperty("reset")
                  ? global.stats.reset
                  : 0;
                let mad = global.stats.hasOwnProperty("mad")
                  ? global.stats.mad
                  : 0;
                let bioseed = global.stats.hasOwnProperty("bioseed")
                  ? global.stats.bioseed
                  : 0;
                let cataclysm = global.stats.hasOwnProperty("cataclysm")
                ...
                if (global.stats.died + global.stats.tdied > 0) {
                  ...
                  gift.push(
                    `${dead.toLocaleString()} ${loc(`resource_Coal_name`)}`,
                  );
                }
                ...
                if (global.race.universe === "antimatter") {
                  ...
                  gift.push(
                    `${plasmid.toLocaleString()} ${loc(`resource_AntiPlasmid_plural_name`)}`,
                  );
                } else {
                  global.prestige.Plasmid.count += plasmid;
                  global.stats.plasmid += plasmid;
                  gift.push(
                    `${plasmid.toLocaleString()} ${loc(`resource_Plasmid_plural_name`)}`,
                  );
                }
                if (phage > 0) {
                  ...
                  gift.push(
                    `${phage.toLocaleString()} ${loc(`resource_Phage_name`)}`,
                  );
                }

                if (global.stats.hasOwnProperty("achieve")) {
                  let universe = global.stats.achieve["whitehole"]
                    ? global.stats.achieve["whitehole"].l
                    : 0;
                  universe += global.stats.achieve["heavy"]
                    ? global.stats.achieve["heavy"].l
                    : 0;
                  universe += global.stats.achieve["canceled"]
                    ? global.stats.achieve["canceled"].l
                    : 0;
                  universe += global.stats.achieve["eviltwin"]
                    ? global.stats.achieve["eviltwin"].l
                    : 0;
                  universe += global.stats.achieve["microbang"]
                    ? global.stats.achieve["microbang"].l
                    : 0;
                  universe += global.stats.achieve["pw_apocalypse"]
                    ? global.stats.achieve["pw_apocalypse"].l
                    : 0;

                  let ascended = global.stats.achieve["ascended"]
                    ? global.stats.achieve["ascended"].l
                    : 0;
                  let descend = global.stats.achieve["corrupted"]
                    ? global.stats.achieve["corrupted"].l
                    : 0;
                  let ai = global.stats.achieve["obsolete"]
                    ? global.stats.achieve["obsolete"].l
                    : 0;
    ...
    food: {
      ...
      title() {
        ...
        if (hallowed.active) {
          return global.tech["conjuring"]
            ? loc("city_trick_conjure")
            : loc("city_trick");
        } else {
          return global.tech["conjuring"]
            ? loc("city_food_conjure")
            : loc("city_food");
        }
      },
      desc() {
        ...
        if (hallowed.active) {
          return global.tech["conjuring"]
            ? loc("city_trick_conjure_desc", [gain])
            : loc("city_trick_desc", [gain]);
        } else {
          return global.tech["conjuring"]
            ? loc("city_food_conjure_desc", [gain])
            : loc("city_food_desc", [gain]);
        }
      },
      category: "outskirts",
      reqs: { primitive: 1 },
    ...
    lumber: {
      ...
      title() {
        let hallowed = getHalloween();
        if (hallowed.active) {
          return global.tech["conjuring"] && global.tech["conjuring"] >= 2
            ? loc("city_dig_conjour")
            : loc("city_dig");
        } else {
          return global.tech["conjuring"] && global.tech["conjuring"] >= 2
            ? loc("city_lumber_conjure")
            : loc("city_lumber");
        }
      },
      desc() {
        ...
        if (hallowed.active) {
          return global.tech["conjuring"] && global.tech["conjuring"] >= 2
            ? loc("city_dig_conjour_desc", [gain])
            : loc("city_dig_desc", [gain]);
        } else {
          return global.tech["conjuring"] && global.tech["conjuring"] >= 2
            ? loc("city_lumber_conjure_desc", [gain])
            : loc("city_lumber_desc", [gain]);
        }
      },
      category: "outskirts",
      reqs: {},
      ...
      val(spend) {
        ...
        if (
          global.tech["conjuring"] &&
          global.tech["conjuring"] >= 2 &&
          global.resource.Mana.amount >= 1
        ) {
          gain *= 10;
          if (
            global["resource"]["Lumber"].amount <
    ...
    stone: {
      ...
      desc() {
        let gain = $(this)[0].val(false);
        if (global.tech["conjuring"] && global.tech["conjuring"] >= 2) {
          return loc("city_stone_conjour_desc", [
            gain,
            global.resource.Stone.name,
          ]);
        } else {
          return loc(
            global.race["sappy"] ? "city_amber_desc" : "city_stone_desc",
            [gain, global.resource.Stone.name],
          );
        }
      },
      category: "outskirts",
      ...
      action(args) {
        if (!global.settings.pause) {
          if (
            global["resource"]["Stone"].amount < global["resource"]["Stone"].max
          ) {
    ...
    chrysotile: {
      ...
      desc() {
        ...
        if (global.tech["conjuring"] && global.tech["conjuring"] >= 2) {
          return loc("city_stone_conjour_desc", [
            gain,
            global.resource.Chrysotile.name,
          ]);
        } else {
          return loc("city_stone_desc", [
            gain,
            global.resource.Chrysotile.name,
          ]);
        }
      ...
      action(args) {
        if (!global.settings.pause) {
          if (
            global["resource"]["Chrysotile"].amount <
            global["resource"]["Chrysotile"].max
          ) {
    ...
    slaughter: {
      ...
      desc() {
        if (global.race["soul_eater"]) {
          return global.tech["primitive"]
            ? global.resource.hasOwnProperty("furs") &&
              global.resource.Furs.display
              ? loc("city_evil_desc3")
              : loc("city_evil_desc2")
            : loc("city_evil_desc1");
        } else {
          return global.resource.hasOwnProperty("furs") &&
            global.resource.Furs.display
            ? loc("city_evil_desc4")
            : loc("city_evil_desc1");
        }
        ...
        if (!global.settings.pause) {
          ...
          if (global.race["soul_eater"]) {
            if (
              ...
              global["resource"]["Food"].amount < global["resource"]["Food"].max
            ) {
          ...
          if (
            global.resource.Furs.display &&
            global["resource"]["Furs"].amount < global["resource"]["Furs"].max
          ) {
    ...
    slave_market: {
      ...
      queue_complete() {
        return global.city["slave_pen"]
          ? global.city.slave_pen.count * 4 - global.resource.Slave.amount
          : 0;
      },
      action(args) {
        if (
    ...
    basic_housing: {
      ...
      desc() {
        return $(this)[0].citizens() === 1
          ? loc("city_basic_housing_desc")
          : loc("city_basic_housing_desc_plural", [$(this)[0].citizens()]);
      },
      ...
      cost: {
        ...
        Lumber(offset) {
          return global.race["kindling_kindred"] || global.race["smoldering"]
            ? 0
            : costMultiplier("basic_housing", offset, 10, 1.23);
        },
        Stone(offset) {
      ...
      effect() {
        ...
        return global.race["sappy"]
          ? `<div>${loc("plus_max_resource", [pop, loc("citizen")])}</div><div>${loc("city_grove_effect", [2.5])}</div>`
    ...
    cottage: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("cottage", offset, 900, 1.15);
        },
        Plywood(offset) {
          return costMultiplier("cottage", offset, 25, 1.25);
        },
        Brick(offset) {
          return costMultiplier("cottage", offset, 20, 1.25);
        },
        Wrought_Iron(offset) {
          return costMultiplier("cottage", offset, 15, 1.25);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("cottage", offset, 5, 1.25)
            : 0;
        },
        Horseshoe() {
    ...
    apartment: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("apartment", offset, 1750, 1.26) - 500;
        },
        Crystal(offset) {
          return global.race.universe === "magic"
            ? costMultiplier("apartment", offset, 25, 1.22)
            : 0;
        },
        Furs(offset) {
          return costMultiplier("apartment", offset, 725, 1.32) - 500;
        },
        Copper(offset) {
          return costMultiplier("apartment", offset, 650, 1.32) - 500;
        },
        Cement(offset) {
          return costMultiplier("apartment", offset, 700, 1.32) - 500;
        },
        Steel(offset) {
          return costMultiplier("apartment", offset, 800, 1.32) - 500;
        },
        Horseshoe() {
    ...
    lodge: {
      ...
      desc() {
        return global.race["detritivore"]
          ? loc("city_lodge_desc_alt")
          : loc("city_lodge_desc");
      },
      category: "residential",
      ...
      not_trait: ["cataclysm", "lone_survivor"],
      condition() {
        return ((global.race["soul_eater"] ||
          global.race["detritivore"] ||
          global.race["artifical"] ||
          global.race["unfathomable"] ||
          global.race["forager"]) &&
          global.tech["s_lodge"]) ||
          (global.tech["hunting"] && global.tech["hunting"] >= 2)
          ? true
          : false;
      },
      cost: {
        Money(offset) {
          return costMultiplier("lodge", offset, 50, 1.32);
        },
        Lumber(offset) {
          return costMultiplier("lodge", offset, 20, 1.36);
        },
        Stone(offset) {
          return costMultiplier("lodge", offset, 10, 1.36);
        },
        Horseshoe() {
          return global.race["hooved"] ? 1 : 0;
        },
      ...
      effect() {
        let pop = $(this)[0].citizens();
        return global.race["carnivore"] && !global.race["artifical"]
          ? `<div>${loc("plus_max_resource", [pop, loc("citizen")])}</div><div>${loc("city_lodge_effect", [5])}</div>`
          : loc("plus_max_resource", [pop, loc("citizen")]);
      },
      action(args) {
        if (payCosts($(this)[0])) {
    ...
    smokehouse: {
      id: "city-smokehouse",
      title() {
        return global.race["hrt"] &&
          ["wolven", "vulpine"].includes(global.race["hrt"])
          ? loc("city_smokehouse_easter")
          : loc("city_smokehouse");
      },
      ...
      cost: {
        Money(offset) {
          return costMultiplier("smokehouse", offset, 85, 1.32);
        },
        Lumber(offset) {
          return costMultiplier("smokehouse", offset, 65, 1.36);
        },
        Stone(offset) {
          return costMultiplier("smokehouse", offset, 50, 1.36);
        },
      },
      effect() {
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          global["resource"]["Food"].max += BHStorageMulti(
            spatialReasoning(100),
          );
          return true;
        }
        return false;
    ...
    soul_well: {
      ...
      cost: {
        Money(offset) {
          offset = offset || 0;
          if (
            (global.city["soul_well"] ? global.city["soul_well"].count : 0) +
              offset >=
            3
          ) {
        ...
        Lumber(offset) {
          return costMultiplier("soul_well", offset, 20, 1.36);
        },
        Stone(offset) {
          return costMultiplier("soul_well", offset, 10, 1.36);
        },
      },
      effect() {
        let souls = BHStorageMulti(spatialReasoning(500));
        let production = global.race["ghostly"]
          ? 2 + traits.ghostly.vars()[1]
          : 2;
    ...
    slave_pen: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("slave_pen", offset, 250, 1.32);
        },
        Lumber(offset) {
          return costMultiplier("slave_pen", offset, 100, 1.36);
        },
        Stone(offset) {
          return costMultiplier("slave_pen", offset, 75, 1.36);
        },
        Copper(offset) {
          return costMultiplier("slave_pen", offset, 10, 1.36);
        },
        Nanite(offset) {
          return global.race["deconstructor"]
            ? costMultiplier("slave_pen", offset, 4, 1.36)
            : 0;
        },
      },
      effect() {
      ...
      cost: {
        Money(offset) {
          if (
            ...
            global.city["transmitter"].count >= 3
          ) {
            return costMultiplier("transmitter", offset, 50, 1.32);
          } else {
            return 0;
          }
        },
        Copper(offset) {
          return costMultiplier("transmitter", offset, 20, 1.36);
        },
        Steel(offset) {
          return costMultiplier("transmitter", offset, 10, 1.36);
        },
      },
      effect() {
    ...
    farm: {
      ...
      cost: {
        Money(offset) {
          offset = offset || 0;
          if (
            (global.city["farm"] ? global.city["farm"].count : 0) + offset >=
            3
          ) {
        ...
        Lumber(offset) {
          return costMultiplier("farm", offset, 20, 1.36);
        },
        Stone(offset) {
          return costMultiplier("farm", offset, 10, 1.36);
        },
        Horseshoe(offset) {
          return global.race["hooved"] &&
            (global.city["farm"] ? global.city["farm"].count : 0) +
              (offset || 0) >=
              2
            ? 1
            : 0;
      ...
      effect() {
        let pop = $(this)[0].citizens();
        return global.tech["farm"]
          ? `<div>${loc("city_farm_effect")}</div><div>${loc("plus_max_resource", [pop, loc("citizen")])}</div>`
          : loc("city_farm_effect");
      },
      action(args) {
        if (payCosts($(this)[0])) {
      ...
      flair() {
        return global.tech.agriculture >= 7
          ? loc("city_farm_flair2")
          : loc("city_farm_flair1");
      },
    },
    compost: {
      id: "city-compost",
      ...
      cost: {
        Money(offset) {
          offset = offset || 0;
          if (
            (global.city["compost"] ? global.city["compost"].count : 0) +
              offset >=
            3
          ) {
        ...
        Lumber(offset) {
          return costMultiplier("compost", offset, 12, 1.36);
        },
        Stone(offset) {
          return costMultiplier("compost", offset, 12, 1.36);
        },
      ...
      effect() {
        let generated =
          1.2 + (global.tech["compost"] ? global.tech["compost"] : 0) * 0.8;
        generated *=
          global.city.biome === "grassland" ? biomes.grassland.vars()[0] : 1;
        generated *=
        ...
        generated *=
          global.city.biome === "hellscape" ? biomes.hellscape.vars()[0] : 1;
        generated *= global.city.ptrait.includes("trashed")
        ...
        let wood =
          global.race["kindling_kindred"] || global.race["smoldering"]
            ? ``
            : `<div class="has-text-caution">${loc("city_compost_heap_effect2", [0.5, global.resource.Lumber.name])}</div>`;
    ...
    mill: {
      id: "city-mill",
      title() {
        return global.tech["agriculture"] >= 5
          ? structName("windmill")
          : loc("city_mill_title1");
      },
      desc() {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("mill", offset, 1000, 1.31);
        },
        Lumber(offset) {
          return costMultiplier("mill", offset, 600, 1.33);
        },
        Iron(offset) {
          return costMultiplier("mill", offset, 150, 1.33);
        },
        Cement(offset) {
          return costMultiplier("mill", offset, 125, 1.33);
        },
      },
      powered() {
        return powerModifier(
          global.race["environmentalist"]
            ? -traits.environmentalist.vars()[1]
            : -1,
        );
      },
    ...
    windmill: {
      id: "city-windmill",
      title() {
        return global.race["unfathomable"]
          ? loc("tech_watermill")
          : structName("windmill");
      },
      desc() {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("windmill", offset, 1000, 1.31);
        },
        Lumber(offset) {
          return costMultiplier("windmill", offset, 600, 1.33);
        },
        Iron(offset) {
          return costMultiplier("windmill", offset, 150, 1.33);
        },
        Cement(offset) {
          return costMultiplier("windmill", offset, 125, 1.33);
        },
      },
      effect() {
        let power = $(this)[0].powered() * -1;
    ...
    silo: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("silo", offset, 85, 1.32);
        },
        Lumber(offset) {
          return costMultiplier("silo", offset, 65, 1.36);
        },
        Stone(offset) {
          return costMultiplier("silo", offset, 50, 1.36);
        },
        Iron(offset) {
          return (global.city.silo ? global.city.silo.count : 0) +
            (offset || 0) >=
            4 && global.city.ptrait.includes("unstable")
            ? costMultiplier("silo", offset, 10, 1.36)
            : 0;
        },
      },
      effect() {
    ...
    garrison: {
      id: "city-garrison",
      title() {
        return global.race["flier"]
          ? loc("city_garrison_flier")
          : loc("city_garrison");
      },
      ...
      cost: {
        Money(offset) {
          return costMultiplier("garrison", offset, 240, 1.5);
        },
        Stone(offset) {
          return costMultiplier("garrison", offset, 260, 1.46);
        },
        Iron(offset) {
          return (global.city["garrison"] ? global.city.garrison.count : 0) +
            (offset || 0) >=
            4 && global.city.ptrait.includes("unstable")
            ? costMultiplier("garrison", offset, 50, 1.4)
            : 0;
        },
        Horseshoe() {
    ...
    hospital: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("hospital", offset, 22000, 1.32);
        },
        Furs(offset) {
          return costMultiplier("hospital", offset, 4000, 1.32);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("hospital", offset, 500, 1.32)
            : 0;
        },
        Aluminium(offset) {
          return costMultiplier("hospital", offset, 10000, 1.32);
        },
      },
      effect() {
        let clinic =
          global.tech["reproduction"] && global.tech.reproduction >= 2
            ? `<div>${loc("city_hospital_effect2")}</div>`
            : ``;
        ...
        if (!global.race["artifical"] && global.race.hasOwnProperty("vax")) {
          desc =
            desc +
            `<div>${loc("tau_home_disease_lab_vax", [+global.race.vax.toFixed(2)])}</div>`;
        }
        return desc;
      },
      action(args) {
    ...
    boot_camp: {
      id: "city-boot_camp",
      title() {
        return global.race["artifical"]
          ? loc("city_boot_camp_art")
          : loc("city_boot_camp");
      },
      desc() {
        return global.race["artifical"]
          ? loc("city_boot_camp_art_desc", [races[global.race.species].name])
          : loc("city_boot_camp_desc");
      },
      category: "military",
      reqs: { boot_camp: 1 },
      not_trait: ["cataclysm", "lone_survivor"],
      cost: {
        Money(offset) {
          return costMultiplier("boot_camp", offset, 50000, 1.32);
        },
        Lumber(offset) {
          return costMultiplier("boot_camp", offset, 21500, 1.32);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("boot_camp", offset, 300, 1.32)
            : 0;
        },
        Aluminium(offset) {
          return costMultiplier("boot_camp", offset, 12000, 1.32);
        },
        Brick(offset) {
          return costMultiplier("boot_camp", offset, 1400, 1.32);
        },
      },
      effect() {
        ...
        let effect =
          global.tech["spy"] && global.tech["spy"] >= 3
            ? `<div>${loc("city_boot_camp_effect", [rate])}</div><div>${loc("city_boot_camp_effect2", [10])}</div>`
            : `<div>${loc("city_boot_camp_effect", [rate])}</div>`;
    ...
    shed: {
      ...
      desc() {
        let storage =
          global.tech["storage"] >= 3
            ? global.tech["storage"] >= 4
              ? loc("city_shed_desc_size3")
              : loc("city_shed_desc_size2")
            : loc("city_shed_desc_size1");
      ...
      cost: {
        Money(offset) {
          return costMultiplier("shed", offset, 75, 1.22);
        },
        Lumber(offset) {
      ...
      res() {
        ...
        if (
          global.tech["shelving"] &&
          global.tech.shelving >= 3 &&
          global.resource.Graphene.display
        ) {
        ...
        if (
          global.tech["shelving"] &&
          global.tech.shelving >= 3 &&
          global.resource.Stanene.display
        ) {
          r_list.push("Stanene");
        }
      ...
      effect(wiki) {
        ...
        for (const res of $(this)[0].res()) {
          if (global.resource[res].display) {
            let val = sizeApproximation(
              +(spatialReasoning($(this)[0].val(res)) * multiplier).toFixed(0),
              1,
            );
            storage =
              storage +
              `<span>${loc("plus_max_resource", [val, global.resource[res].name])}</span>`;
          }
        }
        storage = storage + "</div>";
        return storage;
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          for (const res of $(this)[0].res()) {
            if (global.resource[res].display) {
              global.resource[res].max += spatialReasoning(
                $(this)[0].val(res) * multiplier,
              );
            }
          }
          return true;
    ...
    storage_yard: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("storage_yard", offset, 10, bananaPerk(1.36));
        },
        Brick(offset) {
          return costMultiplier("storage_yard", offset, 3, bananaPerk(1.35));
        },
        Wrought_Iron(offset) {
          return costMultiplier("storage_yard", offset, 5, bananaPerk(1.35));
        },
      },
      effect() {
    ...
    warehouse: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("warehouse", offset, 400, bananaPerk(1.26));
        },
        Cement(offset) {
          return costMultiplier("warehouse", offset, 75, bananaPerk(1.26));
        },
        Sheet_Metal(offset) {
          return costMultiplier("warehouse", offset, 25, bananaPerk(1.25));
        },
      },
      effect() {
    ...
    bank: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier(
            "bank",
            offset,
            traitCostMod("untrustworthy", 250),
            1.35,
          );
        },
        Lumber(offset) {
        ...
        Stone(offset) {
          return costMultiplier(
            "bank",
            offset,
            traitCostMod("untrustworthy", 100),
            1.35,
          );
        },
        Iron(offset) {
          return (global.city["bank"] ? global.city.bank.count : 0) +
            (offset || 0) >=
            2 && global.city.ptrait.includes("unstable")
            ? costMultiplier(
                "bank",
                offset,
                traitCostMod("untrustworthy", 30),
                1.3,
              )
            : 0;
        },
      ...
      effect() {
        ...
        if (global.tech["banking"] >= 2) {
          ...
          return loc("plus_max_resource", [
            `\$${vault}`,
            loc("resource_Money_name"),
          ]);
        }
      },
      action(args) {
    ...
    pylon: {
      ...
      cost: {
        Money(offset) {
          offset = offset || 0;
          if (
            (global.city["pylon"] ? global.city["pylon"].count : 0) + offset >=
            2
          ) {
        ...
        Stone(offset) {
          return costMultiplier("pylon", offset, 12, 1.42);
        },
        Crystal(offset) {
          return costMultiplier("pylon", offset, 8, 1.42) - 3;
        },
      },
      effect() {
    ...
    conceal_ward: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("conceal_ward", offset, 500, 1.25);
        },
        Mana(offset) {
          return costMultiplier(
            "conceal_ward",
        ...
        Crystal(offset) {
          return costMultiplier("conceal_ward", offset, 5, 1.25);
        },
      },
      effect() {
        let ward =
          global.tech["roguemagic"] && global.tech.roguemagic >= 8 ? 1.25 : 1;
    ...
    graveyard: {
      ...
      cost: {
        Money(offset) {
          offset = offset || 0;
          if (
            (global.city["graveyard"] ? global.city["graveyard"].count : 0) +
              offset >=
            5
          ) {
        ...
        Lumber(offset) {
          return costMultiplier("graveyard", offset, 2, 1.95);
        },
        Stone(offset) {
          return costMultiplier("graveyard", offset, 6, 1.9);
        },
      },
      effect() {
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          global["resource"]["Lumber"].max += BHStorageMulti(
            spatialReasoning(100),
          );
          return true;
        }
    ...
    lumber_yard: {
      ...
      cost: {
        ...
        Lumber(offset) {
          return costMultiplier("lumber_yard", offset, 6, 1.9);
        },
        Stone(offset) {
          return costMultiplier("lumber_yard", offset, 2, 1.95);
        },
      },
      effect() {
        let lum = BHStorageMulti(spatialReasoning(100));
    ...
    sawmill: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("sawmill", offset, 3000, 1.26);
        },
        Iron(offset) {
          return costMultiplier("sawmill", offset, 400, 1.26);
        },
        Cement(offset) {
          return costMultiplier("sawmill", offset, 420, 1.26);
        },
      },
      effect() {
        ...
        if (global.tech["foundry"] && global.tech["foundry"] >= 4) {
          desc =
            desc +
            `<div>${loc("crafting", [2, global.resource.Plywood.name])}</div>`;
        }
        if (global.city.powered) {
          desc =
            desc +
            `<div class="has-text-caution">${loc("city_sawmill_effect3", [4, $(this)[0].powered()])}</div>`;
        }
        return desc;
      },
      powered() {
    ...
    rock_quarry: {
      ...
      title() {
        return global.race["flier"]
          ? loc("city_rock_quarry_alt")
          : loc("city_rock_quarry");
      },
      desc() {
        return global.race["flier"]
          ? loc("city_rock_quarry_desc_alt", [global.resource.Stone.name])
          : loc("city_rock_quarry_desc");
      },
      category: "industrial",
      reqs: { mining: 1 },
      ...
      cost: {
        ...
        Lumber(offset) {
          return costMultiplier("rock_quarry", offset, 50, 1.36);
        },
        Stone(offset) {
          return costMultiplier("rock_quarry", offset, 10, 1.36);
        },
      },
      effect() {
        let stone = BHStorageMulti(spatialReasoning(100));
        let asbestos = global.race["smoldering"]
          ? `<div>${loc("plus_max_resource", [stone, global.resource.Chrysotile.name])}</div>`
          : "";
      ...
      powerBalancer() {
        if (global.city.rock_quarry.hasOwnProperty("cnvay")) {
          if (
            global.city.hasOwnProperty("metal_refinery") &&
            global.city.rock_quarry.hasOwnProperty("almcvy")
          ) {
            return [
              { r: "Stone", k: "cnvay" },
    ...
    cement_plant: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("cement_plant", offset, 3000, 1.5);
        },
        Lumber(offset) {
          return costMultiplier("cement_plant", offset, 1800, 1.36);
        },
        Stone(offset) {
          return costMultiplier("cement_plant", offset, 2000, 1.32);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("cement_plant", offset, 275, 1.32)
            : 0;
        },
      },
      effect() {
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          global.civic.cement_worker.max =
            global.city.cement_plant.count * jobScale(2);
          powerOnNewStruct($(this)[0]);
          return true;
        }
        return false;
    ...
    foundry: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("foundry", offset, 750, 1.36);
        },
        Stone(offset) {
          return costMultiplier("foundry", offset, 100, 1.36);
        },
        Copper(offset) {
          return costMultiplier("foundry", offset, 250, 1.36);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("foundry", offset, 40, 1.36)
            : 0;
        },
      },
      effect() {
        ...
        if (payCosts($(this)[0])) {
          if (global.city["foundry"].count === 0) {
            if (global.race["no_craft"]) {
              messageQueue(loc("city_foundry_msg2"), "info", false, [
                "progress",
              ]);
            } else {
              messageQueue(loc("city_foundry_msg1"), "info", false, [
                "progress",
              ]);
            }
          }
    ...
    factory: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("factory", offset, 25000, dirt_adjust(1.32));
        },
        Cement(offset) {
          return costMultiplier("factory", offset, 1000, dirt_adjust(1.32));
        },
        Steel(offset) {
          return costMultiplier("factory", offset, 7500, dirt_adjust(1.32));
        },
        Titanium(offset) {
          return costMultiplier("factory", offset, 2500, dirt_adjust(1.32));
        },
      },
      effect() {
    ...
    smelter: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("smelter", offset, 1000, dirt_adjust(1.32));
        },
        Iron(offset) {
          return costMultiplier("smelter", offset, 500, dirt_adjust(1.33));
        },
      },
      effect() {
        var iron_yield =
    ...
    metal_refinery: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("metal_refinery", offset, 2500, 1.35);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("metal_refinery", offset, 125, 1.35)
            : 0;
        },
        Steel(offset) {
          return costMultiplier("metal_refinery", offset, 350, 1.35);
        },
      },
      powered() {
        return powerCostMod(2);
      ...
      effect() {
        let label = global.race["sappy"]
          ? "city_metal_refinery_effect_alt"
          : "city_metal_refinery_effect";
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          if (
            global.city["foundry"] &&
            global.city.foundry.count > 0 &&
            !global.resource.Sheet_Metal.display
          ) {
            global.resource.Sheet_Metal.display = true;
            loadFoundry();
          }
    ...
    mine: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("mine", offset, 60, dirt_adjust(1.6));
        },
        Lumber(offset) {
          return costMultiplier("mine", offset, 175, dirt_adjust(1.38));
        },
      },
      effect() {
        if (global.tech["mine_conveyor"]) {
      ...
      powerBalancer() {
        return global.city.mine.hasOwnProperty("cpow") &&
          global.city.mine.hasOwnProperty("ipow")
          ? [
              { r: "Copper", k: "cpow" },
              { r: "Iron", k: "ipow" },
            ]
      ...
      flair() {
        return races[global.race.species].type === "avian"
          ? loc(`city_mine_flair_avian`)
          : "";
      },
    },
    coal_mine: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("coal_mine", offset, 480, dirt_adjust(1.4));
        },
        Lumber(offset) {
          return costMultiplier("coal_mine", offset, 250, dirt_adjust(1.36));
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("coal_mine", offset, 28, dirt_adjust(1.36))
            : 0;
        },
        Wrought_Iron(offset) {
          return costMultiplier("coal_mine", offset, 18, dirt_adjust(1.36));
        },
      },
      effect() {
        if (global.tech["mine_conveyor"]) {
      ...
      powerBalancer() {
        return global.city.coal_mine.hasOwnProperty("cpow") &&
          global.city.coal_mine.hasOwnProperty("upow") &&
          global.resource.Uranium.display
          ? [
              { r: "Coal", k: "cpow" },
              { r: "Uranium", k: "upow" },
            ]
          : global.city.coal_mine.hasOwnProperty("cpow")
            ? [{ r: "Coal", k: "cpow" }]
            : false;
      },
      power_reqs: { mine_conveyor: 1 },
    ...
    oil_well: {
      id: "city-oil_well",
      title() {
        return global.race["blubber"]
          ? loc("tech_oil_refinery")
          : loc("city_oil_well");
      },
      desc() {
        return global.race["blubber"]
          ? loc("city_oil_well_blubber")
          : loc("city_oil_well_desc");
      },
      category: "industrial",
      reqs: { oil: 1 },
      not_trait: ["cataclysm", "lone_survivor"],
      cost: {
        Money(offset) {
          return costMultiplier("oil_well", offset, 5000, dirt_adjust(1.5));
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("oil_well", offset, 450, dirt_adjust(1.5))
            : 0;
        },
        Cement(offset) {
          return costMultiplier("oil_well", offset, 5250, dirt_adjust(1.5));
        },
        Steel(offset) {
          return costMultiplier("oil_well", offset, 6000, dirt_adjust(1.5));
        },
      },
      effect() {
        ...
        if (global.race["blubber"] && global.city.hasOwnProperty("oil_well")) {
          let maxDead =
            ...
            (global.space["oil_extractor"]
              ? global.space.oil_extractor.count
              : 0);
    ...
    oil_depot: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("oil_depot", offset, 2500, dirt_adjust(1.46));
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("oil_depot", offset, 325, dirt_adjust(1.36))
            : 0;
        },
        Cement(offset) {
          return costMultiplier("oil_depot", offset, 3750, dirt_adjust(1.46));
        },
        Sheet_Metal(offset) {
          return costMultiplier("oil_depot", offset, 100, dirt_adjust(1.45));
        },
      },
      effect() {
        ...
        if (global.resource["Helium_3"].display) {
          ...
          effect =
            effect +
            `<div>${loc("plus_max_resource", [val, global.resource.Helium_3.name])}.</div>`;
        }
        if (global.tech["uranium"] >= 2) {
          ...
          effect =
            effect +
            `<div>${loc("plus_max_resource", [val, global.resource.Uranium.name])}.</div>`;
        }
        return effect;
      },
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          global["resource"]["Oil"].max +=
            spatialReasoning(1000) * (global.tech["world_control"] ? 1.5 : 1);
          if (global.resource["Helium_3"].display) {
            global["resource"]["Helium_3"].max +=
              spatialReasoning(400) * (global.tech["world_control"] ? 1.5 : 1);
          }
          if (global.tech["uranium"] >= 2) {
            global["resource"]["Uranium"].max +=
              spatialReasoning(250) * (global.tech["world_control"] ? 1.5 : 1);
          }
          return true;
        }
        return false;
    ...
    trade: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("trade", offset, 500, 1.36);
        },
        Lumber(offset) {
          return costMultiplier("trade", offset, 125, 1.36);
        },
        Stone(offset) {
          return costMultiplier("trade", offset, 50, 1.36);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("trade", offset, 15, 1.36)
            : 0;
        },
        Furs(offset) {
          return costMultiplier("trade", offset, 65, 1.36);
        },
      },
      effect() {
    ...
    wharf: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("wharf", offset, 62000, 1.32);
        },
        Lumber(offset) {
          return costMultiplier("wharf", offset, 44000, 1.32);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("wharf", offset, 200, 1.32)
            : 0;
        },
        Cement(offset) {
          return costMultiplier("wharf", offset, 3000, 1.32);
        },
        Oil(offset) {
          return costMultiplier("wharf", offset, 750, 1.32);
        },
      },
      effect() {
    ...
    tourist_center: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("tourist_center", offset, 100000, 1.36);
        },
        Stone(offset) {
          return costMultiplier("tourist_center", offset, 25000, 1.36);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("tourist_center", offset, 1000, 1.36)
            : 0;
        },
        Furs(offset) {
          return costMultiplier("tourist_center", offset, 7500, 1.36);
        },
        Plywood(offset) {
          return costMultiplier("tourist_center", offset, 5000, 1.36);
        },
      },
      effect(wiki) {
        let xeno =
          global.tech["monument"] &&
          global.tech.monument >= 3 &&
          isStargateOn(wiki)
            ? 3
            : 1;
    ...
    amphitheatre: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("amphitheatre", offset, 500, 1.55);
        },
        Lumber(offset) {
          return costMultiplier("amphitheatre", offset, 50, 1.75);
        },
        Stone(offset) {
          return costMultiplier("amphitheatre", offset, 200, 1.75);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("amphitheatre", offset, 18, 1.36)
            : 0;
        },
      },
      effect() {
      ...
      flair() {
        ...
        let athVal = govActive("athleticism", 0);
        return athVal
          ? loc("city_stadium_flair")
          : loc("city_amphitheatre_flair");
      },
    },
    casino: {
      id: "city-casino",
      ...
      cost: {
        Money(offset) {
          return costMultiplier(
            "casino",
            offset,
            traitCostMod("untrustworthy", 350000),
            1.35,
          );
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier(
                "casino",
                offset,
                traitCostMod("untrustworthy", 2000),
                1.35,
              )
            : 0;
        },
        Furs(offset) {
          return costMultiplier(
            "casino",
            offset,
            traitCostMod("untrustworthy", 60000),
            1.35,
          );
        },
        Plywood(offset) {
          return costMultiplier(
            "casino",
            offset,
            traitCostMod("untrustworthy", 10000),
            1.35,
          );
        },
        Brick(offset) {
          return costMultiplier(
            "casino",
            offset,
            traitCostMod("untrustworthy", 6000),
            1.35,
          );
        },
      },
      effect() {
        ...
        desc =
          desc +
          `<div class="has-text-caution">${loc("minus_power", [$(this)[0].powered()])}</div>`;
        return desc;
      },
      powered() {
        return powerCostMod(
          global.stats.achieve["dissipated"] &&
            global.stats.achieve["dissipated"].l >= 2
            ? 2
            : 3,
        );
      },
    ...
    temple: {
      ...
      desc() {
        let entity =
          global.race.gods !== "none"
            ? races[global.race.gods.toLowerCase()].entity
            : races[global.race.species].entity;
        return global.race.universe === "evil" &&
          global.civic.govern.type != "theocracy"
          ? loc("city_temple_desc_evil", [entity])
          : loc("city_temple_desc", [entity]);
      },
      category: "commercial",
      reqs: { theology: 2 },
      not_trait: ["cataclysm", "lone_survivor"],
      cost: {
        Money(offset) {
          return costMultiplier("temple", offset, 50, 1.36);
        },
        Lumber(offset) {
          return costMultiplier("temple", offset, 25, 1.36);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("temple", offset, 6, 1.36)
            : 0;
        },
        Furs(offset) {
          return costMultiplier("temple", offset, 15, 1.36);
        },
        Cement(offset) {
          return costMultiplier("temple", offset, 10, 1.36);
        },
      },
      effect() {
        ...
        if (global.genes["ancients"] && global.genes["ancients"] >= 2) {
          desc =
            desc +
            `<div>${loc("plus_max_resource", [jobScale(1), global.civic?.priest?.name || loc(`job_priest`)])}</div>`;
        }
        if (global.race.universe === "evil") {
          desc += `<div>${loc("plus_max_resource", [0.5, global.resource.Authority.name])}</div>`;
        }
    ...
    wonder_lighthouse: {
      ...
      reqs: {},
      condition() {
        return global.race["wish"] &&
          global.race["wishStats"] &&
          global.city["wonder_lighthouse"]
          ? true
          : false;
      },
      trait: ["wish"],
    ...
    banquet: {
      ...
      reqs: { banquet: 1 },
      queue_complete() {
        return global.stats.achieve["endless_hunger"]
          ? global.stats.achieve["endless_hunger"].l -
      ...
      condition() {
        return global.stats.achieve["endless_hunger"] &&
          global.stats.achieve["endless_hunger"].l >= 1
          ? true
          : false;
      },
      cost: {
        Money(offset) {
          const level =
            (offset ? offset : 0) +
            (global.city["banquet"] ? global.city["banquet"].level : 0);
          switch (level) {
            case 0:
              return 45000;
            case 1:
      ...
      effect(wiki) {
        let strength = global.city["banquet"]
    ...
    university: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("university", offset, 900, 1.5) - 500;
        },
        Lumber(offset) {
          return costMultiplier("university", offset, 500, 1.36) - 200;
        },
        Stone(offset) {
          return costMultiplier("university", offset, 750, 1.36) - 350;
        },
        Crystal(offset) {
          return global.race.universe === "magic"
            ? costMultiplier("university", offset, 5, 1.36)
            : 0;
        },
        Iron(offset) {
          return (global.city["university"]
            ? global.city.university.count
            : 0) +
            (offset || 0) >=
            3 && global.city.ptrait.includes("unstable")
            ? costMultiplier("university", offset, 25, 1.36)
            : 0;
        },
      },
      effect(wiki) {
      ...
      knowVal(wiki) {
        let multiplier = 1;
        let base =
          global.tech["science"] && global.tech["science"] >= 8 ? 700 : 500;
        ...
        if (global.space["observatory"] && global.space.observatory.count > 0) {
          multiplier +=
            (wiki ? global.space.observatory.on : support_on["observatory"]) *
            0.05;
        }
        if (global.portal["sensor_drone"] && global.tech["science"] >= 14) {
          multiplier +=
            (wiki ? global.portal.sensor_drone.on : p_on["sensor_drone"]) *
            0.02;
        }
        ...
        let num_tech_scavs_on = sg_on
          ? wiki
            ? (global.galaxy?.scavenger?.on ?? 0)
            : gal_on["scavenger"]
          : 0;
    ...
    library: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("library", offset, 45, 1.2);
        },
        Crystal(offset) {
          return global.race.universe === "magic"
            ? costMultiplier("library", offset, 2, 1.2)
            : 0;
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("library", offset, 4, 1.2)
            : 0;
        },
        Furs(offset) {
          return costMultiplier("library", offset, 22, 1.2);
        },
        Plywood(offset) {
          return costMultiplier("library", offset, 20, 1.2);
        },
        Brick(offset) {
          return costMultiplier("library", offset, 15, 1.2);
        },
      },
      effect() {
        let gain = 125;
      ...
      action(args) {
        if (payCosts($(this)[0])) {
          ...
          if (global.tech["science"] && global.tech.science >= 5) {
            gain *=
              1 +
              workerScale(global.civic.scientist.workers, "scientist") * 0.12;
          }
          gain = +gain.toFixed(1);
          global["resource"]["Knowledge"].max += gain;
          ...
          if (global.tech["science"] && global.tech.science >= 3) {
            global.civic.professor.impact =
              0.5 + global.city.library.count * 0.01;
          }
          return true;
        }
        return false;
    ...
    wardenclyffe: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("wardenclyffe", offset, 5000, 1.22);
        },
        Knowledge(offset) {
          return costMultiplier(
            "wardenclyffe",
            offset,
            global.race["logical"] ? 1000 - traits.logical.vars()[0] : 1000,
            1.22,
          );
        },
        Crystal(offset) {
          return global.race.universe === "magic"
            ? costMultiplier("wardenclyffe", offset, 100, 1.22)
            : 0;
        },
        Copper(offset) {
          return costMultiplier("wardenclyffe", offset, 500, 1.22);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("wardenclyffe", offset, 75, 1.22)
            : 0;
        },
        Cement(offset) {
          return costMultiplier("wardenclyffe", offset, 350, 1.22);
        },
        Sheet_Metal(offset) {
          return costMultiplier("wardenclyffe", offset, 125, 1.2);
        },
        Nanite(offset) {
          return global.race["deconstructor"]
            ? costMultiplier("wardenclyffe", offset, 50, 1.18)
            : 0;
        },
      },
      effect() {
        ...
        if (global.city.powered) {
          ...
          if (global.race.universe === "magic") {
            ...
            desc =
              desc +
              `<div>${loc("plus_max_resource", [mana, global.resource.Mana.name])}</div>`;
          }
          if (global.tech["broadcast"]) {
            let morale = global.tech["broadcast"];
            desc =
              desc +
              `<div class="has-text-caution">${loc("city_wardenclyffe_effect3", [$(this)[0].powered(), pgain.toLocaleString(), morale])}</div>`;
          } else {
            desc =
              desc +
              `<div class="has-text-caution">${loc("city_wardenclyffe_effect2", [$(this)[0].powered(), pgain.toLocaleString()])}</div>`;
          }
          if (global.race["artifical"]) {
            desc =
              desc +
              `<div class="has-text-caution">${loc("city_transmitter_effect", [spatialReasoning(250)])}</div`;
          }
        }
        return desc;
      },
      ...
      flair() {
        return global.race.universe === "magic"
          ? `<div>${loc("city_wizard_tower_flair")}</div>`
          : global.race["evil"]
            ? `<div>${loc("city_babel_flair")}</div>`
            : `<div>${loc("city_wardenclyffe_flair1")}</div><div>${loc("city_wardenclyffe_flair2")}</div>`;
      },
    },
    biolab: {
      id: "city-biolab",
      ...
      cost: {
        Money(offset) {
          return costMultiplier("biolab", offset, 25000, 1.3);
        },
        Knowledge(offset) {
          return costMultiplier("biolab", offset, 5000, 1.3);
        },
        Copper(offset) {
          return costMultiplier("biolab", offset, 1250, 1.3);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("biolab", offset, 160, 1.3)
            : 0;
        },
        Alloy(offset) {
          return costMultiplier("biolab", offset, 350, 1.3);
        },
      },
      effect(wiki) {
        let gain = 3000;
        ...
        if (
          global.race["elemental"] &&
          traits.elemental.vars()[0] === "frost"
        ) {
          gain *=
            1 +
    ...
    coal_power: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("coal_power", offset, 10000, dirt_adjust(1.22));
        },
        Crystal(offset) {
          return global.race.universe === "magic"
            ? costMultiplier("coal_power", offset, 125, dirt_adjust(1.22))
            : 0;
        },
        Copper(offset) {
          return (
            costMultiplier("coal_power", offset, 1800, dirt_adjust(1.22)) - 1000
          );
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("coal_power", offset, 175, dirt_adjust(1.22))
            : 0;
        },
        Cement(offset) {
          return costMultiplier("coal_power", offset, 600, dirt_adjust(1.22));
        },
        Steel(offset) {
          return (
            costMultiplier("coal_power", offset, 2000, dirt_adjust(1.22)) - 1000
          );
        },
      },
      effect() {
        ...
        return global.race["environmentalist"]
          ? `+${power}MW`
          : `<span>+${power}MW.</span> <span class="has-text-caution">${loc(global.race.universe === "magic" ? "city_mana_engine_effect" : "city_coal_power_effect", [consume])}</span>`;
      },
      powered(wiki) {
        let power =
          global.stats.achieve["dissipated"] &&
          global.stats.achieve["dissipated"].l >= 1
            ? -6
            : -5;
    ...
    oil_power: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("oil_power", offset, 50000, dirt_adjust(1.22));
        },
        Copper(offset) {
          return (
            costMultiplier("oil_power", offset, 6500, dirt_adjust(1.22)) + 1000
          );
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("oil_power", offset, 180, dirt_adjust(1.22))
            : 0;
        },
        Aluminium(offset) {
          return costMultiplier("oil_power", offset, 12000, dirt_adjust(1.22));
        },
        Cement(offset) {
          return (
            costMultiplier("oil_power", offset, 5600, dirt_adjust(1.22)) + 1000
          );
        },
      },
      effect() {
        ...
        return global.race["environmentalist"]
          ? `+${power}MW`
          : `<span>+${power}MW.</span> <span class="has-text-caution">${loc("city_oil_power_effect", [consume])}</span>`;
      },
      powered(wiki) {
        let power = 0;
        if (
          global.stats.achieve["dissipated"] &&
          global.stats.achieve["dissipated"].l >= 3
        ) {
    ...
    fission_power: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("fission_power", offset, 250000, 1.36);
        },
        Copper(offset) {
          return costMultiplier("fission_power", offset, 13500, 1.36);
        },
        Iron(offset) {
          return global.city.ptrait.includes("unstable")
            ? costMultiplier("fission_power", offset, 1750, 1.36)
            : 0;
        },
        Cement(offset) {
          return costMultiplier("fission_power", offset, 10800, 1.36);
        },
        Titanium(offset) {
          return costMultiplier("fission_power", offset, 7500, 1.36);
        },
      },
      effect() {
        let consume = 0.1;
    ...
    mass_driver: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("mass_driver", offset, 375000, 1.32);
        },
        Copper(offset) {
          return costMultiplier("mass_driver", offset, 33000, 1.32);
        },
        Iron(offset) {
          return costMultiplier("mass_driver", offset, 42500, 1.32);
        },
        Iridium(offset) {
          return costMultiplier("mass_driver", offset, 2200, 1.32);
        },
      },
      effect() {
        let exo =
          global.tech.mass >= 2
            ? `<div>${loc("city_mass_driver_effect2", [1, global.civic.scientist.name])}</div>`
            : "";
      ...
      powered() {
        let power =
          global.stats.achieve["dissipated"] &&
          global.stats.achieve["dissipated"].l >= 4
            ? 4
            : 5;
  ...
  starDock: {
      ...
      cost: {
        Money(offset) {
          return costMultiplier(
            ...
            offset,
            350000,
            global.race["truepath"] ? 1.125 : 1.25,
            "starDock",
          );
        },
        Alloy(offset) {
    ...
    geck: {
      ...
      reqs: { geck: 1 },
      condition() {
        return global.stats.achieve["lamentis"] &&
          global.stats.achieve.lamentis.l >= 5
          ? true
          : false;
      },
      queue_complete() {
      ...
      cost: {
        Money(offset) {
          return costMultiplier("geck", offset, 1000000, 1.25, "starDock");
        },
        Elerium(offset) {
          return costMultiplier("geck", offset, 1000, 1.25, "starDock");
        },
        Plasmid(offset) {
          return costMultiplier("geck", offset, 25, 1.4, "starDock");
        },
      },
      effect() {
    ...
    seeder: {
      id: "starDock-seeder",
      title() {
        return global.race["cataclysm"]
          ? loc("star_dock_exodus")
          : loc("star_dock_seeder");
      },
      desc() {
        let label = global.race["cataclysm"]
          ? loc("star_dock_exodus")
          : loc("star_dock_seeder");
      ...
      cost: {
        Money(offset) {
          return (offset || 0) +
            (global.starDock.hasOwnProperty("seeder")
      ...
      effect(wiki) {
        let count =
          (wiki?.count ?? 0) +
          (global.starDock["seeder"] ? global.starDock.seeder.count : 0);
        let remain =
          count < 100
            ? loc("star_dock_seeder_status1", [100 - count])
            : loc("star_dock_seeder_status2");
    ...
    prep_ship: {
      ...
      desc() {
        let label = global.race["cataclysm"]
          ? loc("star_dock_prep_cata_desc")
          : loc("star_dock_prep_desc");
      ...
      cost: {
        Helium_3(offset, wiki) {
          return +fuel_adjust(
            global.race["gravity_well"] ? 150000 : 75000,
            false,
            wiki,
          ).toFixed(0);
        },
      ...
      effect() {
        ...
        let label = global.race["cataclysm"]
          ? loc("star_dock_prep_cata_effect")
          : loc("star_dock_prep_effect");
      ...
      effect() {
        ...
        let plasmidType =
          global.race.universe === "antimatter"
            ...
            : loc("resource_Plasmid_plural_name");
        let label = global.race["cataclysm"]
          ? loc("star_dock_genesis_cata_effect1")
          : loc("star_dock_genesis_effect1");
        return `<div>${label}</div><div class="has-text-special">${loc("star_dock_genesis_effect2", [gains.plasmid, plasmidType])}</div><div class="has-text-special">${loc("star_dock_genesis_effect3", [gains.phage])}</div>`;
      },
      action(args) {
        bioseed();
...
export function setChallengeScreen() {
  ...
  if (
    global.stats.achieve["whitehole"] ||
  ...
  if (
    ...
    (global.stats.achieve["whitehole"] || global["sim"])
  ) {
    //global.evolution['nonstandard'] = { count: 0 };
  }
  if (
    global.race.universe === "heavy" &&
    ((global.stats.achieve["seeder"] && global.stats.achieve.seeder["h"]) ||
      global["sim"])
  ) {
  ...
  if (
    global.race.universe === "magic" &&
    ((global.stats.achieve["ascended"] &&
      global.stats.achieve.ascended["mg"]) ||
      global["sim"])
  ) {
  ...
  if (
    global.race.universe === "evil" &&
    ((global.stats.achieve["godslayer"] &&
      global.stats.achieve.godslayer["e"]) ||
      global["sim"])
  ) {
  ...
  if (
    ((global.stats.achieve["ascended"] || global.stats.achieve["corrupted"]) &&
  ...
  if (
    (global.stats.achieve["godslayer"] &&
      global.stats.achieve["extinct_sludge"]) ||
    global["sim"]
  ) {
  ...
  if (global.race["warlord"]) {
    ...
    ["custom", "hybrid", "nano", "sentience"].forEach(function (r) {
      if (
        $(`#evolution-${r}`).length > 0 &&
        $(`#evolution-${r}`).hasClass("disabled")
      ) {
...
export function buildTemplate(key, region) {
  let tName = global.race["orbit_decay"]
    ? "orbit_decayed"
    : global.race["warlord"]
      ? "warlord"
      : "cataclysm";
  ...
  switch (key) {
    case "bonfire": {
      let action = {
        ...
        effect() {
          ...
          let goal =
            global.resource.Thermite.amount < thermite
              ? `<div class="has-text-warning">${loc("city_bonfire_effect3", [thermite.toLocaleString()])}</div><div class="has-text-caution">${loc("city_bonfire_effect4", [(+global.resource.Thermite.amount.toFixed(0)).toLocaleString(), thermite.toLocaleString()])}</div>`
              : ``;
    ...
    case "firework": {
      let action = {
        ...
        condition() {
          return (
            eventActive(`firework`) &&
            global[region].firework &&
            (global.tech["cement"] || global.race["flier"])
          );
        },
        cost: {
          Money() {
            return global[region].firework.count === 0 ? 50000 : 0;
          },
          Iron() {
            return global[region].firework.count === 0 ? 7500 : 0;
          },
          Cement() {
            return global[region].firework.count === 0 ? 10000 : 0;
          },
        },
        queue_complete() {
        ...
        effect() {
          return global[region].firework.count === 0
            ? loc(`city_firework_build`)
            : loc(`city_firework_effect`);
        },
        action(args) {
    ...
    case "assembly": {
      ...
      let action = {
        ...
        cost: {
          Money(offset) {
            return global["resource"][global.race.species].amount
              ? costMultiplier("citizen", offset, assemblyCostAdjust(125), 1.01)
              : 0;
          },
          Copper(offset) {
            return global.race["deconstructor"]
              ? 0
              : global["resource"][global.race.species].amount >= 5
                ? costMultiplier(
                    "citizen",
                    offset,
                    assemblyCostAdjust(50),
                    1.01,
                  )
                : 0;
          },
        ...
        effect() {
          ...
          if (
            ...
            if (
              global.race["last_assembled"] &&
              global.race.last_assembled + buffer >= global.stats.days
            ) {
    ...
    case "captive_housing": {
      let action = {
        ...
        cost: {
          Money(offset) {
            return costMultiplier("captive_housing", offset, 40, 1.35);
          },
          Lumber(offset) {
            return costMultiplier("captive_housing", offset, 30, 1.35);
          },
          Stone(offset) {
            return costMultiplier("captive_housing", offset, 18, 1.35);
          },
        },
        effect() {
          let desc = ``;
          if (
            ...
            let cattle = global.city.hasOwnProperty("captive_housing")
              ? global.city.captive_housing.cattle
              : 0;
            let cattleCap = global.city.hasOwnProperty("captive_housing")
          ...
          let raceCap = global.city.hasOwnProperty("captive_housing")
        ...
        action(args) {
          if (payCosts($(this)[0])) {
            ...
            global.city.captive_housing.raceCap =
              houses *
              (global.tech["unfathomable"] && global.tech.unfathomable >= 3
                ? 3
                : 2);
      ...
      let action = {
        ...
        cost: {
          Lumber(offset) {
            ...
            let active =
              ...
              (!global.resource.Copper.display || shoes <= 12)
                ? true
                : false;
            return active
              ? Math.round(
          ...
          Copper(offset) {
            ...
            let lum =
              global.race["kindling_kindred"] || global.race["smoldering"]
                ...
                : true;
            let active =
              (!lum || (lum && shoes > 12 && global.resource.Copper.display)) &&
              (!global.resource.Iron.display || shoes <= 75)
                ? true
                : false;
            return active
              ? Math.round(
          ...
          Iron(offset) {
            let shoes = (global.race["shoecnt"] || 0) + (offset || 0);
            return global.resource.Iron.display &&
              shoes > 75 &&
              (!global.resource.Steel.display || shoes <= 150)
              ? Math.round(
                  (shoes <= 150 ? 12 : 28) *
                    shoes *
                    (traits.hooved.vars()[0] / 100),
          ...
          Steel(offset) {
            let shoes = (global.race["shoecnt"] || 0) + (offset || 0);
            return global.resource.Steel.display &&
              shoes > 150 &&
              (!global.resource.Adamantite.display || shoes <= 500)
              ? Math.round(
                  (shoes <= 500 ? 40 : 100) *
                    shoes *
                    (traits.hooved.vars()[0] / 100),
          ...
          Adamantite(offset) {
            let shoes = (global.race["shoecnt"] || 0) + (offset || 0);
            return global.resource.Adamantite.display &&
              shoes > 500 &&
              (!global.resource.Orichalcum.display || shoes <= 5000)
              ? Math.round(
                  (shoes <= 5000 ? 5 : 25) *
                    shoes *
                    (traits.hooved.vars()[0] / 100),
          ...
          Orichalcum(offset) {
            let shoes = (global.race["shoecnt"] || 0) + (offset || 0);
            return global.resource.Orichalcum.display && shoes > 5000
              ? Math.round(
                  (25 * shoes - 120000) * (traits.hooved.vars()[0] / 100),
                )
              : 0;
          },
        },
        action(args) {
          ...
          if (global.resource.Horseshoe.display && payCosts($(this)[0])) {
            ...
            if (
              (global.race.shoecnt === 5001 &&
                global.resource.Orichalcum.display) ||
              (global.race.shoecnt === 501 &&
              ...
              (global.race.shoecnt === 13 &&
                global.resource.Copper.display &&
                global.resource.Lumber.display)
            ) {
              return 0;
            }
            return true;
    ...
    case "s_alter": {
      let action = {
        ...
        desc() {
          return global.city.hasOwnProperty("s_alter") &&
            global.city["s_alter"].count >= 1
            ? `<div>${loc("city_s_alter")}</div><div class="has-text-special">${loc("city_s_alter_desc")}</div>`
            : loc("city_s_alter");
        },
        category: "outskirts",
        reqs: { mining: 1 },
        ...
        cost: {
          Stone(offset) {
            return (offset || 0) +
              (global.city.hasOwnProperty("s_alter")
        ...
        effect() {
          let sacrifices = global.civic[global.civic.d_job]
            ? global.civic[global.civic.d_job].workers
            : 0;
          let desc = `<div class="has-text-caution">${loc("city_s_alter_sacrifice", [sacrifices])}</div>`;
          if (
            global.city.hasOwnProperty("s_alter") &&
            global.city.s_alter.rage > 0
          ) {
            desc =
              desc +
              `<div>${loc("city_s_alter_rage", [traits.cannibalize.vars()[0], timeFormat(global.city.s_alter.rage)])}</div>`;
          }
          if (
            global.city.hasOwnProperty("s_alter") &&
            ...
            desc =
              desc +
              `<div>${loc("city_s_alter_regen", [traits.cannibalize.vars()[0], timeFormat(global.city.s_alter.regen)])}</div>`;
          }
          if (
            global.city.hasOwnProperty("s_alter") &&
            global.city.s_alter.mind > 0
          ) {
            desc =
              desc +
              `<div>${loc("city_s_alter_mind", [traits.cannibalize.vars()[0], timeFormat(global.city.s_alter.mind)])}</div>`;
          }
          if (
            global.city.hasOwnProperty("s_alter") &&
            global.city.s_alter.mine > 0
          ) {
            desc =
              desc +
              `<div>${loc("city_s_alter_mine", [traits.cannibalize.vars()[0], timeFormat(global.city.s_alter.mine)])}</div>`;
          }
          if (
            global.city.hasOwnProperty("s_alter") &&
            ...
            desc =
              desc +
              `<div>${loc("city_s_alter_harvest", [traits.cannibalize.vars()[0], timeFormat(global.city.s_alter.harvest), jobType])}</div>`;
          }
          return desc;
        },
        action(args) {
    ...
    case "shrine": {
      let action = {
        ...
        desc() {
          return global.race["warlord"]
            ? loc("city_shrine_warlord_desc")
            : loc("city_shrine_desc");
        },
        category: "commercial",
        reqs: { theology: 2 },
        trait: ["magnificent"],
        ...
        cost: {
          Money(offset) {
            return costMultiplier("shrine", offset, 75, 1.32);
          },
          Stone(offset) {
            return costMultiplier("shrine", offset, 65, 1.32);
          },
          Furs(offset) {
            return costMultiplier("shrine", offset, 10, 1.32);
          },
          Copper(offset) {
            return costMultiplier("shrine", offset, 15, 1.32);
          },
        },
        effect() {
          ...
          if (global.city["shrine"] && morale.active) {
            desc =
              desc +
              `<div>${loc("city_shrine_morale", [+morale.add.toFixed(1)])}</div>`;
          }
          if (global.city["shrine"] && metal.active) {
            desc =
              desc +
              `<div>${loc("city_shrine_metal", [+((metal.mult - 1) * 100).toFixed(2)])}</div>`;
          }
          if (global.city["shrine"] && know.active) {
            desc =
              desc +
              `<div>${loc("city_shrine_know", [(+know.add.toFixed(1)).toLocaleString()])}</div>`;
            desc =
              desc +
              `<div>${loc(global.race["warlord"] ? "city_shrine_warlord" : "city_shrine_know2", [+((know.mult - 1) * 100).toFixed(1)])}</div>`;
          }
          if (global.city["shrine"] && tax.active) {
            desc =
              desc +
              `<div>${loc("city_shrine_tax", [+((tax.mult - 1) * 100).toFixed(1)])}</div>`;
          }
          return desc;
        },
        action(args) {
    ...
    case "meditation": {
      let action = {
        ...
        cost: {
          Money(offset) {
            return costMultiplier("meditation", offset, 50, 1.2);
          },
          Stone(offset) {
            return costMultiplier("meditation", offset, 25, 1.2);
          },
          Furs(offset) {
            return costMultiplier("meditation", offset, 8, 1.2);
          },
        },
        effect() {
          let zen =
...
function genus_condition(r, t) {
  ...
  return (
    ((global.tech[t] && global.tech[t] === r) || global.evolution["gselect"]) &&
    f < 100
  );
}
...
raceList.forEach(function (race) {
  if (
    !["custom", "hybrid"].includes(race) ||
    (race === "custom" && global.custom.hasOwnProperty("race0")) ||
    (race === "hybrid" && global.custom.hasOwnProperty("race1"))
  ) {
    if (race === "hybrid" && global.custom.race1.genus !== "hybrid") {
      global.custom.race1.hybrid = [
        global.custom.race1.genus,
        global.custom.race1.genus === "humanoid" ? "small" : "humanoid",
      ];
    ...
    actions.evolution[race] = {
      ...
      condition() {
        let typeList =
          global.stats.achieve["godslayer"] && races[race].type === "hybrid"
            ? races[race].hybrid
            : [races[race].type];
        let typeCheck = false;
        ...
        return (
          (global.race.seeded ||
            ...
            (global.stats.achieve[`extinct_${race}`] &&
              global.stats.achieve[`extinct_${race}`].l >= 1)) &&
          typeCheck &&
          global.evolution.final === 100 &&
          !global.race["evoFinalMenu"]
        );
      ...
      action(args) {
        if (
          global.race["warlord"] &&
          ["custom", "hybrid", "nano"].includes(race)
        ) {
          return false;
        }
        if (payCosts($(this)[0])) {
...
if (Object.keys(global.stats.synth).length > 1) {
  let synthList = deepClone(
    raceList.filter((r) => !["nano", "synth"].includes(r)),
  );
  synthList.forEach(
    (race) =>
      (actions.evolution[`s-${race}`] = {
        id: `evolution-s-${race}`,
        title() {
          return races[race].name;
        },
        ...
        condition() {
          ...
          return (
            (global.stats.synth[race] || global["beta"]) &&
            global.race["evoFinalMenu"]
          );
        },
        cost: {},
...
Object.keys(challengeList).forEach(
  (challenge) =>
    (actions.evolution[challenge] = {
...
Object.keys(advancedChallengeList).forEach(
  (challenge) =>
    (actions.evolution[challenge] = {
      id: `evolution-${challenge}`,
      title: loc(`evo_challenge_${challenge}`),
      desc() {
        ...
        if (global.race.universe === "micro") {
          desc =
            desc +
            `<div class="has-text-danger">${loc("evo_challenge_micro_warn")}</div>`;
        }
        desc = desc + `<div>${loc(`evo_challenge_${challenge}_desc`)}</div>`;
        if (["sludge", "junker", "ultra_sludge"].includes(challenge)) {
          desc =
            desc + `<div class="has-text-danger">${loc("evo_start")}</div>`;
        }
        return desc;
      },
      condition() {
...
export function drawEvolution() {
  ...
  if (
    ...
    (global.race.seeded && !global.race["chose"])
  ) {
    return;
  }
    ...
    if (!actions.evolution[evo]["challenge"]) {
      ...
      if (actions.evolution[evo].hasOwnProperty("reqs")) {
        Object.keys(actions.evolution[evo].reqs).forEach(function (req) {
          if (
            !global.tech[req] ||
            global.tech[req] < actions.evolution[evo].reqs[req]
          ) {
            isMet = false;
          }
        });
...
function challengeEffect(c) {
  switch (c) {
    ...
    case "junker": {
      return global.city.biome === "hellscape" &&
        global.race.universe !== "evil"
        ? `<div>${loc("evo_challenge_junker_effect")}</div><div class="has-text-special">${loc("evo_warn_unwise")}</div>`
        : loc("evo_challenge_junker_effect");
    }
    case "cataclysm": {
      if (calc_mastery() >= 50) {
    ...
    case "gravity_well": {
      ...
      let max_cement =
        ...
        containers +
        storageMultipler(
          warehouses * coeff * actions.city.shed.val(cement_name),
        );
      let num_fuel_depot = 0; // max with no CRISPR is usually 20 fuel depots
      let offset = global.city?.oil_depot?.count ?? 0;
      while (true) {
        let costs = adjustCosts(
          actions.city.oil_depot,
          num_fuel_depot - offset,
        );
      ...
      let max_derrick =
        max_cement +
        storageMultipler(warehouses * coeff * actions.city.shed.val("Steel"));
      let num_oil_derrick = 0; // max with no CRISPR is usually 16 oil derricks
      offset = global.city?.oil_well?.count ?? 0;
      while (true) {
        let costs = adjustCosts(
          actions.city.oil_well,
          num_oil_derrick - offset,
        );
      ...
      let max_oil = spatialReasoning(
        1000 * unified * num_fuel_depot +
          500 * num_oil_derrick +
          1250 * unified * num_propellant_depot,
      );
      offset = global.space?.propellant_depot?.count ?? 0;
      while (true) {
        let costs = adjustCosts(
          actions.space.spc_home.propellant_depot,
          num_propellant_depot - offset,
        );
...
export function templeEffect() {
  ...
  if (global.race.universe === "antimatter" || global.race["no_plasmid"]) {
    ...
    if (global.race.universe === "antimatter") {
      ...
      if (
        ...
        global.civic.priest.display
      ) {
        let priest =
          global.genes["ancients"] >= 5
            ? 0.12
            : global.genes["ancients"] >= 3
              ? 0.1
              : 0.08;
        if (global.race["high_pop"]) {
  ...
  if (global.tech["anthropology"] && global.tech["anthropology"] >= 4) {
    desc =
      desc +
      `<div>${global.race["truepath"] ? loc("city_temple_effect_tp", [2, 25]) : loc("city_temple_effect4")}</div>`;
  }
  return desc;
}
...
export function casinoEarn() {
  ...
  if (
    ...
    global.portal.hell_casino.rank > 1
  ) {
    let rank = global.portal.hell_casino.rank - 1;
    cash *= 1 + rank * 0.36;
  }
...
export function casinoEffect() {
  ...
  let joy =
    global.tech["theatre"] && !global.race["joyless"]
      ? `<div>${loc("plus_max_resource", [jobScale(global.race["warlord"] ? 3 : 1), loc(`job_entertainer`)])}</div>`
      : "";
  let banker =
    global.race["orbit_decayed"] ||
    global.tech["isolation"] ||
    global.race["warlord"]
      ? `<div>${loc("plus_max_resource", [jobScale(1), loc("banker_name")])}</div>`
      : "";
...
function evolveCosts(molecule, base, mult, offset) {
  let count =
    (global.evolution.hasOwnProperty(molecule)
      ? global.evolution[molecule].count
      : 0) + (offset || 0);
...
function setScenario(scenario) {
  ...
  if (global.race[scenario]) {
    ...
    let genes =
      scenario === "truepath" || scenario === "lone_survivor"
        ? ["badgenes", "trade", "craft"]
        : ["crispr", "trade", "craft"];
...
export function storageMultipler(scale = 1, wiki = false) {
  ...
  if (global.tech["storage"] >= 7 && global.interstellar["cargo_yard"]) {
    multiplier *=
      1 + (global.interstellar["cargo_yard"].count * get_qlevel(wiki)) / 100;
  }
...
export function checkCityRequirements(action) {
  ...
  if (
    actions.city[action].hasOwnProperty("path") &&
    !actions.city[action].path.includes(c_path)
  ) {
    return false;
  }
  var isMet = true;
  Object.keys(actions.city[action].reqs).forEach(function (req) {
    if (
      !global.tech[req] ||
      global.tech[req] < actions.city[action].reqs[req]
    ) {
      isMet = false;
    }
  });
...
function checkTechPath(tech) {
  ...
  if (
    (!techPath[path].includes(actions.tech[tech].era) &&
      !actions.tech[tech].hasOwnProperty("path")) ||
    (actions.tech[tech].hasOwnProperty("path") &&
      !actions.tech[tech].path.includes(path))
  ) {
    return false;
  }
  return true;
...
export function checkTechRequirements(tech, predList) {
  ...
  if (
    predList &&
    typeof predList === "object" &&
    global.genes.hasOwnProperty("queue") &&
    global.genes.queue >= 3
  ) {
    precog = true;
    global.r_queue.queue.forEach(function (q) {
      if (checkTechRequirements(q.type, false)) {
        predList[actions[q.action][q.type].grant[0]] = {
          v: actions[q.action][q.type].grant[1],
          a: q.type,
        };
      }
    });
    Object.keys(failChecks).forEach(function (req) {
      ...
      if (
        !predList[req] ||
        predList[req].v < actions.tech[tech].reqs[req] ||
        predList[req].v > cTech + 1
      ) {
        precog = false;
      }
    });
  ...
  if (
    (isMet || precog) &&
    (!global.tech[actions.tech[tech].grant[0]] ||
      global.tech[actions.tech[tech].grant[0]] < actions.tech[tech].grant[1])
  ) {
...
export function drawCity() {
  if (
    ...
    (global.settings.civTabs !== 1 || global.settings.spaceTabs !== 0)
  ) {
    return;
  }
  ...
  Object.keys(actions.city).forEach(function (city_name) {
    ...
    if (!checkCityRequirements(city_name)) return;
  ...
  city_categories.forEach(function (category) {
    ...
    if (global.settings["cLabels"]) {
      if (!(category in city_buildings)) return;

      $(`<div id="city-dist-${category}" class="city"></div>`)
        .appendTo("#city")
        .append(
          `<div><h3 class="name has-text-warning">${loc(`city_dist_${category}`)}</h3></div>`,
        );
...
export function drawTech() {
  ...
  Object.keys(actions.tech).forEach(function (tech_name) {
    ...
    if (isOld === true) {
      ...
      let era =
        global.race["truepath"] && tp_era[c_action.era]
          ? tp_era[c_action.era]
          : c_action.era;
  ...
  Object.keys(new_techs).forEach(function (era) {
    if (new_techs[era].length > 0) {
      $(`#tech`).append(
        `<div><h3 class="name has-text-warning">${loc(`tech_era_${era}`)}</h3></div>`,
      );
      ...
      new_techs[era].sort(function (a, b) {
        ...
        if (
          actions.tech[a.t].cost.Omniscience != undefined &&
          actions.tech[b.t].cost.Omniscience != undefined
        ) {
          return actions.tech[a.t].cost.Omniscience() >
            actions.tech[b.t].cost.Omniscience()
            ? 1
            : -1;
        }
        return actions.tech[a.t].cost.Knowledge() >
          actions.tech[b.t].cost.Knowledge()
          ? 1
          : -1;
      });
  ...
  old_categories.forEach(function (category) {
    ...
    $(`<div id="tech-dist-old-${category}" class="tech"></div>`)
      .appendTo("#oldTech")
      .append(
        `<div><h3 class="name has-text-warning">${loc(`tech_dist_${category}`)}</h3></div>`,
      );
...
export function setAction(c_action, action, type, old, prediction) {
  ...
  let parent =
    c_action["highlight"] && c_action.highlight()
      ? $(
          `<div id="${id}" class="action hl"${reqs} role="group" :aria-label="control_group_label()"></div>`,
        )
      : $(
          `<div id="${id}" class="action"${reqs} role="group" :aria-label="control_group_label()"></div>`,
        );
  ...
  if (old) {
    element = $(
      '<span class="oldTech is-dark"><span class="aTitle">{{ title }}</span></span>',
    );
  } else {
    let cst = "";
    let data = "";
    if (c_action["cost"]) {
      let costs =
        action !== "genes" && action !== "blood"
          ? adjustCosts(c_action)
          : c_action.cost;
    ...
    let active = c_action["highlight"]
      ? c_action.highlight()
        ? `<span class="is-sr-only">${loc("active")}</span>`
        : `<span class="is-sr-only">${loc("not_active")}</span>`
      : "";
    element = $(
      `<a class="button is-dark${cst}${clss}"${data} v-on:click="action" role="button"><span class="aTitle" v-html="$options.filters.title(title)"></span>${active}</a><a role="button" v-on:click="describe" class="is-sr-only">{{ title }} description</a>`,
    );
  }
  parent.append(element);

  if (
    c_action.hasOwnProperty("special") &&
    ((typeof c_action["special"] === "function" && c_action.special()) ||
      c_action["special"] === true)
  ) {
    let special =
      $(`<div tabindex="0" class="special" role="button" v-bind:title="title | options" :aria-label="title | options" @click="trigModal"><svg version="1.1" x="0px" y="0px" width="12px" height="12px" viewBox="340 140 280 279.416" enable-background="new 340 140 280 279.416" xml:space="preserve">
  ...
  if (c_action["on"] || c_action["off"]) {
    if (c_action["on"]) {
      let powerOn = $(
        `<span class="on" aria-hidden="true" title="ON" v-html="$options.filters.val('on')"></span>`,
      );
      parent.append(powerOn);
    }
    if (c_action["off"]) {
      let powerOff = $(
        `<span class="off" aria-hidden="true" title="OFF" v-html="$options.filters.val('off')"></span>`,
      );
      parent.append(powerOff);
    }
  } else {
    let switchable = c_action["switchable"]
      ? c_action.switchable()
      : c_action["powered"] &&
    ...
    if (switchable) {
      let powerOn = $(
        `<span tabindex="0" role="button" :aria-label="on_label()" class="on" @click="power_on" title="ON" v-html="$options.filters.p_on(act.on,'${c_action.id}')"></span>`,
      );
      let powerOff = $(
        `<span tabindex="0" role="button" :aria-label="off_label()" class="off" @click="power_off" title="OFF" v-html="$options.filters.p_off(act.on,'${c_action.id}')"></span>`,
      );
      parent.append(powerOn);
      parent.append(powerOff);
    }
  ...
  if (c_action["count"]) {
    ...
    global[action] &&
    global[action][type] &&
    global[action][type].count >= 0
  ) {
    element.append(
      $(
        `<span class="count" v-html="$options.filters.count(act.count,'${type}')"></span>`,
      ),
    );
  } else if (
    action === "blood" &&
    global[action] &&
    global[action][c_action.grant[0]] &&
    global[action][c_action.grant[0]] > 0 &&
    c_action.grant[1] === "*"
  ) {
    element.append(
      $(`<span class="count"> ${global[action][c_action.grant[0]]} </span>`),
    );
  }
  if (
    action !== "tech" &&
    global[action] &&
    global[action][type] &&
    typeof global[action][type]["repair"] !== "undefined"
  ) {
    element.append(
      $(
        `<div class="repair"><progress class="progress" aria-label="${loc("repair")}" :value="repair()" :max="repairMax()"></progress></div>`,
      ),
    );
  }
  if (old) {
  ...
  vBind({
    ...
    data: {
      title:
        typeof c_action.title === "string" ? c_action.title : c_action.title(),
    ...
    methods: {
      action(args) {
        if (
          ...
          navigator.userAgent.match(/Mobi/ && global.settings.touch)
            ? true
            : false
        ) {
          return;
      ...
      control_group_label() {
        return `${this.title} controls`;
      },
      on_label() {
        return `${this.title} on: ${global[action][type].on}`;
      },
      off_label() {
        return `${this.title} off: ${global[action][type].count - global[action][type].on}`;
      },
      power_on() {
    ...
    switch (action) {
      case "tech":
        if (
          ...
          checkTechRequirements(type, false) &&
          c_action.action({ isQueue: false })
        ) {
          gainTech(type);
          if (c_action["post"]) {
          ...
          if (
            !(c_action["no_queue"] && c_action["no_queue"]()) &&
            global.tech["r_queue"]
          ) {
      ...
      default: {
        ...
        for (let i = 0; i < loopNum; i++) {
          ...
          if (
            (global.settings.qKey && keyMap.q) ||
            !(res = c_action.action({ isQueue: false }))
          ) {
            if (
              res !== 0 &&
              global.tech["queue"] &&
              (keyMult === 1 || (global.settings.qKey && keyMap.q))
            ) {
              let used = 0;
              ...
              for (let j = 0; j < global.queue.queue.length; j++) {
                used += Math.ceil(
                  global.queue.queue[j].q / global.queue.queue[j].qs,
                );
              ...
              if (used < global.queue.max && buid_max > 0) {
                ...
                let q_size = c_action["queue_size"]
                  ? c_action["queue_size"]
                  : 1;
                if (c_action["region"]) {
                ...
                if (global.settings.q_merge !== "merge_never") {
                  if (
                    global.queue.queue.length > 0 &&
                    global.queue.queue[global.queue.queue.length - 1].id ===
                      c_action.id
                  ) {
                    global.queue.queue[global.queue.queue.length - 1].q +=
                      Math.min(buid_max, q_size * repeat);
                  } else {
                    global.queue.queue.push({
                      ...
                      cna: false,
                      time: 0,
                      q: Math.min(buid_max, q_size * repeat),
                      qs: q_size,
                      t_max: 0,
                      bres: false,
                    });
...
export function setPlanet(opt) {
  ...
  if (
    ...
    global.stats.achieve.lamentis.l >= 4 &&
    global.custom["planet"] &&
    opt.custom &&
    opt.custom.length > 0 &&
    Math.floor(seededRandom(0, 10)) === 0
  ) {
    custom = opt.custom[Math.floor(seededRandom(0, opt.custom.length))];
    let target = custom.split(":");

    if (
      global.custom.planet[target[0]] &&
      global.custom.planet[target[0]][target[1]]
    ) {
  ...
  var element = $(
    `<a class="button is-dark" v-on:click="action" role="button"><span class="aTitle">${title}</span></a>`,
  );
  parent.append(element);
  ...
  $("#" + id).on("click", function () {
    if (
      global.stats.achieve["lamentis"] &&
      global.stats.achieve.lamentis.l >= 5 &&
      global.race.hasOwnProperty("geck") &&
      global.race.geck > 0
    ) {
...
function planetDesc(obj, title, biome, orbit, trait, geology, gecked) {
  obj.popper.append(
    $(`<div>${loc("set_planet", [title, biomes[biome].label, orbit])}</div>`),
  );
  ...
  if (gecked && gecked > 0) {
    obj.popper.append(
      $(`<div class="has-text-special">${loc(`rejuvenated`)}</div>`),
    );
  }
  return undefined;
}
  ...
  if (aspect === "biome") {
      ...
      case 0:
        {
          let sb =
            subbiome &&
            global.stats.achieve["biome_grassland"] &&
            global.stats.achieve.biome_grassland[uAffix] &&
            global.stats.achieve.biome_grassland[uAffix] > 0;
      ...
      case 1:
        {
          let sb =
            subbiome &&
            global.stats.achieve["biome_oceanic"] &&
            global.stats.achieve.biome_oceanic[uAffix] &&
            global.stats.achieve.biome_oceanic[uAffix] > 0;
      ...
      case 2:
        {
          let sb =
            subbiome &&
            global.stats.achieve["biome_forest"] &&
            global.stats.achieve.biome_forest[uAffix] &&
            global.stats.achieve.biome_forest[uAffix] > 0;
          biome = sb
            ? Math.floor(seededRandom(0, 2)) === 0
              ? "taiga"
              : "swamp"
            : "forest";
        }
      ...
      case 3:
        {
          let sb =
            subbiome &&
            global.stats.achieve["biome_desert"] &&
            global.stats.achieve.biome_desert[uAffix] &&
            global.stats.achieve.biome_desert[uAffix] > 0;
      ...
      case 4:
        {
          let sb =
            subbiome &&
            global.stats.achieve["biome_volcanic"] &&
            global.stats.achieve.biome_volcanic[uAffix] &&
            global.stats.achieve.biome_volcanic[uAffix] > 0;
      ...
      case 5:
        {
          let sb =
            subbiome &&
            global.stats.achieve["biome_tundra"] &&
            global.stats.achieve.biome_tundra[uAffix] &&
            global.stats.achieve.biome_tundra[uAffix] > 0;
    ...
    for (let i = 0; i < cap; i++) {
      ...
      switch (Math.floor(seededRandom(0, top))) {
        ...
        case 11:
          if (
            !trait.includes("permafrost") &&
            !["volcanic", "ashland", "hellscape"].includes(args["biome"])
          ) {
...
export function powerOnNewStruct(c_action) {
  ...
  if (
    !global.hasOwnProperty(parts[0]) ||
    !global[parts[0]].hasOwnProperty(parts[1])
  ) {
    return false;
  }
  ...
  if (
    need_p &&
    global.city.hasOwnProperty("powered") &&
    checkPowerRequirements(c_action)
  ) {
  ...
  let need_s =
    c_action.hasOwnProperty("s_type") &&
    c_action.hasOwnProperty("support") &&
    c_action.support() < 0;
  let can_s = !need_s;
  if (need_s) {
    let grids = gridDefs();
    ...
    can_s =
      global[s_r][s_rs].support - c_action.support() <= global[s_r][s_rs].s_max;
  }
...
export function planetGeology(geology) {
  ...
  if (Object.keys(geology).length > 0) {
    let good = ``;
    let bad = ``;
    let numShow = global.stats.achieve["miners_dream"]
      ? global.stats.achieve["miners_dream"].l >= 4
        ? global.stats.achieve["miners_dream"].l * 2 - 3
        : global.stats.achieve["miners_dream"].l
      : 0;
    if (
      global.stats.achieve["lamentis"] &&
      global.stats.achieve.lamentis.l >= 0
    ) {
      numShow++;
    }
...
function srDesc(c_action, old) {
  let desc =
    typeof c_action.desc === "string" ? c_action.desc : c_action.desc();
  desc = desc + ". ";
  if (c_action.cost && !old) {
    ...
    Object.keys(costs).forEach(function (res) {
      if (res === "Custom") {
        ...
        Object.keys(structs).forEach(function (region) {
          Object.keys(structs[region]).forEach(function (struct) {
            ...
            if (structs[region][struct].hasOwnProperty("s")) {
              ...
              label =
                typeof actions[region][sector][struct].title === "string"
                  ? actions[region][sector][struct].title
                  : actions[region][sector][struct].title();
              if (check_on) {
              ...
              label =
                typeof actions[region][struct].title === "string"
                  ? actions[region][struct].title
                  : actions[region][struct].title();
              if (check_on) {
            ...
            if (!global[region][struct]) {
              ...
              structs[region][struct].count > global[region][struct].count
            ) {
              desc = desc + `${loc("insufficient")} ${label}. `;
        ...
        if (res_cost > 0) {
          let label =
            f_res === "Money" ? "$" : global.resource[f_res].name + ": ";
          ...
          if (global.resource[f_res].amount < res_cost) {
            desc =
              desc + `${loc("insufficient")} ${global.resource[f_res].name}. `;
          }
        }
      }
    });
  ...
  if (c_action.effect) {
    let effect =
      typeof c_action.effect === "string" ? c_action.effect : c_action.effect();
    if (effect) {
      desc = desc + effect + ". ";
    }
  }
  if (c_action.flair) {
    let flair =
      typeof c_action.flair === "string" ? c_action.flair : c_action.flair();
    if (flair) {
      desc = desc + flair + ".";
    }
  }
...
export function actionDesc(parent, c_action, obj, old, action, a_type, bres) {
  ...
  if (
    ...
    global.settings.touch
      ? true
      : false
  ) {
    touch = $(
      `<a id="touchButton" class="button is-dark touchButton">${c_action.hasOwnProperty("touchlabel") ? c_action.touchlabel : loc("construct")}</a>`,
    );
    parent.append(touch);
  ...
  if (c_action["category"] && type === "tech" && !old) {
    parent.append(
      $(
        `<div class="has-text-flair">${loc("tech_dist_category")}: ${loc(`tech_dist_${c_action.category}`)}</div>`,
      ),
    );
  }
      ...
      if (res === "Custom") {
        ...
        Object.keys(structs).forEach(function (region) {
          Object.keys(structs[region]).forEach(function (struct) {
            ...
            const check_on = structs[region][struct].hasOwnProperty("on");
            let num_on;
            let res_cost = check_on
              ? structs[region][struct].on
              : structs[region][struct].count;
            ...
            if (!global[region][struct]) {
              ...
              aria = ' <span class="is-sr-only">(insufficient)</span>';
            }

            empty = false;
            cost.append(
              $(`<div class="${color}">${label}: ${res_cost}${aria}</div>`),
            );
          });
        });
      } else if (global.prestige.hasOwnProperty(res)) {
        ...
        if (res_cost > 0) {
          ...
          cost.append(
            $(
              `<div class="${color} res-${res}" data-${res}="${res_cost}">${label}: ${res_cost}${aria}</div>`,
            ),
          );
        }
      } else if (res === "Supply") {
          ...
          if (res === "HellArmy") {
            ...
            if (
              global.portal.fortress.garrison -
                global.portal.fortress.patrols *
                  global.portal.fortress.patrol_size <
              res_cost
            ) {
              if (tc.r === f_res) {
                color = "has-text-danger";
            ...
            cost.append(
              $(
                `<div class="${color}" data-${res}="${res_cost}">${label}: ${res_cost}${aria}</div>`,
              ),
            );
          } else if (res === "Troops") {
            let label =
            ...
            if (global.resource[f_res].amount < res_cost) {
              ...
              if (bres && bres !== res && tc.r === f_res) {
                ...
                aria =
                  ' <span class="is-sr-only">(first blocking resource)</span>';
              ...
              aria =
                ' <span class="is-sr-only">(last blocking resource)</span>';
            }
            let display_cost = sizeApproximation(res_cost, 1);
            empty = false;
            cost.append(
              $(
                `<div class="${color} res-${res}" data-${f_res}="${res_cost}">${label}${display_cost}${aria}</div>`,
              ),
            );
          }
        }
  ...
  if (c_action["reqs"]) {
    ...
    Object.keys(c_action.reqs).forEach(function (r) {
      ...
      if (req) {
        reqList.push(
          typeof actions.tech[req].title === "string"
            ? actions.tech[req].title
            : actions.tech[req].title(),
        );
      }
    });
    if (reqList.length > 0) {
      ...
      parent.append(
        $(
          `<div class="has-text-caution">${loc("requires_tech", [listing])}</div>`,
        ),
      );
    }
  }
  ...
  if (
    !old &&
    c_action.id.substring(0, 5) !== "blood" &&
    !checkAffordable(c_action) &&
    checkAffordable(c_action, true)
  ) {
    ...
    if (obj && obj["time"]) {
      parent.append(
        $(
          `<div id="popTimer" class="flair has-text-advanced">{{ time | timer }}</div>`,
        ),
      );
      vBind({
        el: "#popTimer",
      ...
      parent.append(
        $(
          `<div class="flair has-text-advanced">${loc("action_ready", [time])}</div>`,
        ),
      );
    }
  }
  if (
    c_action.id === "portal-spire" ||
    (c_action.id === "portal-waygate" && global.tech.waygate >= 2)
  ) {
    if (obj && obj["time"]) {
      parent.append(
        $(
      ...
      vBind({
        ...
        filters: {
          timer(t) {
            let time =
              !c_action.hasOwnProperty("mscan") ||
              (c_action.hasOwnProperty("mscan") && c_action.mscan() > 0)
                ? t
                : "???";
  ...
  if (checkCosts(costs)) {
    Object.keys(costs).forEach(function (res) {
      if (global.prestige.hasOwnProperty(res)) {
        ...
        global.civic[global.civic.d_job].workers = Math.max(
          0,
          global.civic[global.civic.d_job].workers - cost,
        );
      } else if (
        res !== "Morale" &&
        res !== "Army" &&
  ...
  if (!zig && global.city["temple"]) {
    ...
    if (
      ...
      if (
        global.race["wish"] &&
        global.race["wishStats"] &&
        global.race.wishStats.temple
      ) {
        count++;
      }
      if (
        global.genes.hasOwnProperty("ancients") &&
        global.genes.ancients >= 6
      ) {
        count++;
      }
    }
    ...
    if (!global.race["lone_survivor"] && !global.race["warlord"]) {
      if (
        global.race["wish"] &&
        global.race["wishStats"] &&
        global.race.wishStats.zigg
      ) {
        count++;
      }
      if (
        global.genes.hasOwnProperty("ancients") &&
        global.genes.ancients >= 7
      ) {
        count++;
      }
    }
...
function checkMaxCosts(costs) {
  ...
  Object.keys(costs).forEach(function (res) {
    if (res === "Custom") {
      ...
      if (
        armyRating(global.civic.garrison.raid, "army") < Number(costs[res]())
      ) {
        test = false;
        return;
      }
      ...
      if (
        typeof global.portal["fortress"] === "undefined" ||
        global.portal.fortress.garrison -
      ...
      if (
        !global.portal.hasOwnProperty("purifier") ||
        global.portal.purifier.sup_max < Number(costs[res]())
      ) {
        test = false;
        return;
      }
      ...
      let f_res = res === "Species" ? global.race.species : res;
      if (
        (!global.resource[f_res].display && testCost > 0) ||
        (global.resource[f_res].max >= 0 &&
          testCost > Number(global.resource[f_res].max) &&
          Number(global.resource[f_res].max) !== -1)
      ) {
        test = false;
        return;
      }
...
export function checkCosts(costs) {
  ...
  Object.keys(costs).forEach(function (res) {
    if (res === "Custom") {
      ...
      if (
        !global.portal.hasOwnProperty("purifier") ||
        global.portal.purifier.supply < Number(costs[res]())
      ) {
        test = false;
        return;
      }
      ...
      let f_res = res === "Species" ? global.race.species : res;
      if (
        testCost > Number(global.resource[f_res].amount) ||
        (global.resource[f_res].max >= 0 &&
          testCost > global.resource[f_res].max)
      ) {
        test = false;
        return;
      }
...
function challengeGeneHeader() {
  ...
  challenge.append(
    $(
      `<div class="divider has-text-warning"><h2 class="has-text-danger">${loc("evo_challenge_genes")}</h2></div>`,
    ),
  );
  challenge.append(
    $(
      `<div class="has-text-advanced">${loc("evo_challenge_genes_desc")}</div>`,
    ),
  );
  if (global.genes["challenge"] && global.genes["challenge"] >= 2) {
    challenge.append(
      $(
        `<div class="has-text-advanced">${loc("evo_challenge_genes_mastery")}</div>`,
      ),
    );
  }
}
...
function challengeActionHeader() {
  ...
  challenge.append(
    $(
      `<div class="divider has-text-warning"><h2 class="has-text-danger">${loc("evo_challenge_run")}</h2></div>`,
    ),
  );
  challenge.append(
    $(`<div class="has-text-advanced">${loc("evo_challenge_run_desc")}</div>`),
  );
}
...
function scenarioActionHeader() {
  ...
  challenge.append(
    $(
      `<div class="divider has-text-warning"><h2 class="has-text-danger">${loc("evo_scenario")}</h2></div>`,
    ),
  );
  challenge.append(
    $(`<div class="has-text-advanced">${loc("evo_scenario_desc")}</div>`),
  );
}
...
function exitSimulation() {
  ...
  challenge.append(
    $(
      `<div class="divider has-text-warning"><h2 class="has-text-danger">${loc("evo_challenge_simulation")}</h2></div>`,
    ),
  );
  challenge.append(
    $(
      `<div class="has-text-advanced">${loc("evo_challenge_simulation_desc")}</div>`,
    ),
  );
  challenge.append(
    $(
      `<button class="button simButton" @click="exitsim()">${loc(`evo_challenge_end_sim`)}</button>`,
    ),
  );
...
function configSimulation() {
  ...
  [
    ...
    let simId = `simCfg_${res}`;
    config.append(
      $(
        `<div><label for="${simId}" class="has-text-warning">${loc(`resource_${res}_name`)}</label><input type="number" min="0" class="input" id="${simId}" v-model="${res}"></div>`,
      ),
    );
  });
...
function drawModal(c_action, type) {
  let title =
    typeof c_action.title === "string" ? c_action.title : c_action.title();
  $("#modalBox").append(
    $(`<p id="modalBoxTitle" class="has-text-warning modalTitle">${title}</p>`),
  );
...
function starDockModal(modal) {
  if (global.tech["genesis"] < 4) {
    let warn = $(
      `<div><span class="has-text-warning">${loc("stardock_warn")}</span></div>`,
    );
    modal.append(warn);
    return;
  }
...
export function orbitDecayed() {
  if (
    global.race["orbit_decay"] &&
    global.stats.hasOwnProperty("days") &&
    ...
    if (global.race["tidal_decay"]) {
      ...
      messageQueue(
        loc("evo_challenge_orbit_decayed_msg", [
    ...
    if (global.race.universe === "magic") {
      if (global.city["pylon"]) {
        global.space["pylon"] = {
          count: Math.ceil(global.city.pylon.count / 2),
        };
      }
      cancelRituals();
    }
    ...
    Object.keys(actions.city).forEach(function (k) {
      if (
        global.city.hasOwnProperty(k) &&
        global.city[k].hasOwnProperty("count")
      ) {
        if (global.race["hooved"]) {
          if (actions.city[k].cost.hasOwnProperty("Horseshoe")) {
            global.race["shoecnt"] -=
              actions.city[k].cost.Horseshoe() * global.city[k].count;
          }
        }
    ...
    Object.keys(actions.space.spc_moon).forEach(function (k) {
      if (
        global.space.hasOwnProperty(k) &&
        global.space[k].hasOwnProperty("count")
      ) {
    ...
    ["forager", "farmer", "lumberjack", "quarry_worker"].forEach(
      function (job) {
    ...
    if (global.queue.hasOwnProperty("queue")) {
      for (let i = global.queue.queue.length - 1; i >= 0; i--) {
        ...
        if (
          item.action === "city" ||
          (item.action === "space" && actions.space.spc_moon[item.type])
        ) {
...
export function evoProgress() {
  clearElement($("#evolution .evolving"), true);
  let progress = $(
    `<div class="evolving"><progress class="progress" aria-label="${loc("evolution")} ${loc("progress")}" value="${global.evolution.final}" max="100">${global.evolution.final}%</progress></div>`,
  );
...
export function wardenLabel() {
  if (global.race.universe === "magic") {
    ...
    return global.race["evil"]
      ? loc("city_babel_title")
      : loc("city_wardenclyffe");
  }
}
...
function basicHousingLabel() {
  ...
  return global.city.ptrait.includes("trashed")
    ? loc("city_basic_housing_trash_title")
    : loc("city_basic_housing_title");
}
...
export function structName(type) {
  ...
  switch (type) {
    ...
    case "dormitory": {
      return halloween.active
        ? loc(`events_halloween_dorm`)
        : loc(`galaxy_dormitory`);
    }
    case "mine": {
    ...
    case "coal_mine": {
      return halloween.active
        ? loc(`events_halloween_coal_mine`)
        : loc("city_coal_mine");
    }
    case "lumberyard": {
      return halloween.active
        ? loc(`events_halloween_lumberyard`)
        : loc("city_lumber_yard");
    }
    case "sawmill": {
      return halloween.active
        ? loc(`events_halloween_sawmill`)
        : loc("city_sawmill");
    }
    case "hospital": {
      return halloween.active
        ? loc(`events_halloween_hospital`)
        : loc("city_hospital");
    }
    case "windmill": {
      return halloween.active
        ? loc(`events_halloween_windmill`)
        : loc("city_mill_title2");
    }
    case "factory": {
      return halloween.active
        ? loc(`events_halloween_factory`)
        : loc("city_factory");
    }
    case "storage_yard": {
      return halloween.active
        ? loc(`events_halloween_storage_yard`)
        : loc("city_storage_yard");
    }
    case "temple": {
      return halloween.active
        ? loc(`events_halloween_temple`)
        : global.race.universe === "evil" &&
            global.civic.govern.type != "theocracy"
          ? loc("city_propaganda")
          : loc("city_temple");
          ...
          Object.keys(actions[currItem.action]).forEach(function (region) {
            if (actions[currItem.action][region][currItem.type] && scan) {
              global.queue.queue[i].label =
                typeof actions[currItem.action][region][currItem.type].title ===
                "string"
...
function evoExtraState(race) {
  if (
    (race === "synth" ||
      (race === "custom" && global.custom.race0.traits.includes("imitation")) ||
      (race === "hybrid" &&
        global.custom.race1.traits.includes("imitation"))) &&
    Object.keys(global.stats.synth).length > 1
  ) {
...
function sentience() {
  ...
  if (
    ...
    global.race.species === "sludge" ||
    global.race.species === "ultra_sludge"
  ) {
    setJType();
  }
  ...
  if (global.race["warlord"]) {
    ...
    let typeList =
      global.stats.achieve["godslayer"] &&
      races[global.race.species].type === "hybrid"
        ? races[global.race.species].hybrid
    ...
    typeList.forEach(function (type) {
      Object.keys(genus_def[type].traits).forEach(function (trait) {
        ...
        if (mainspec) {
          ...
          if (
            global.stats.achieve["pathfinder"] &&
            global.stats.achieve.pathfinder.l >= 4
          ) {
            setTraitRank(trait);
          }
        } else {
    ...
    if (
      global.race["evil"] &&
      global.race["maintype"] &&
      global.race.maintype === "angelic"
    ) {
  ...
  if (global.race.universe === "evil") {
    ...
    global.race.universe === "antimatter" &&
    (!global.stats.feat["annihilation"] ||
      global.stats.feat["annihilation"] < alevel())
  ) {
  ...
  if (
    ...
    global.custom.hasOwnProperty("race0")
  ) {
  ...
  if (
    global.race.species === "hybrid" &&
    global.custom.hasOwnProperty("race1")
  ) {
    global.race["untapped"] = calcGenomeScore({
  ...
  Object.keys(global.genes.minor).forEach(function (trait) {
    global.race[trait] =
      trait === "mastery"
        ? global.genes.minor[trait]
        : global.genes.minor[trait] * 2;
  });
  ...
  while (
    (civ0name.s0 === civ2name.s0 && civ0name.s1 === civ2name.s1) ||
    (civ1name.s0 === civ2name.s0 && civ1name.s1 === civ2name.s1)
  ) {
    civ2name = genCivName();
  }
  ...
  if (global.race["truepath"] || global.race["lone_survivor"]) {
    global.civic.foreign.gov0.mil = Math.round(
      global.civic.foreign.gov0.mil * 1.5,
    );
    global.civic.foreign.gov1.mil = Math.round(
      global.civic.foreign.gov1.mil * 1.4,
    );
    global.civic.foreign.gov2.mil = Math.round(
      global.civic.foreign.gov2.mil * 1.25,
    );
  ...
  if (global.race["cataclysm"]) {
    ...
    messageQueue(
      loc("sentience", [
        loc(
          "genelab_genus_" +
            (global.race.maintype || races[global.race.species].type),
        ),
        races[global.race.species].entity,
        flib("name"),
      ]),
  ...
  if (
    global.stats.achieve["technophobe"] &&
    global.stats.achieve.technophobe.l >= 1
  ) {
    ...
    if (global.stats.achieve.technophobe.l >= 3) {
      ...
      for (let i = 1; i < universe_affixes.length; i++) {
        if (
          global.stats.achieve.technophobe[universe_affixes[i]] &&
          global.stats.achieve.technophobe[universe_affixes[i]] >= 5
        ) {
          gems++;
        }
      }
  ...
  if (global.settings.tabLoad) {
    ...
    if (tmp_vars.hasOwnProperty("resource")) {
      Object.keys(tmp_vars.resource).forEach(function (name) {
        ...
        if (stackable) {
          var market_item = $(
            `<div id="stack-${name}" class="market-item" v-show="display"></div>`,
          );
        ...
        if (tradable) {
          var market_item = $(
            `<div id="market-${name}" class="market-item" v-show="r.display"></div>`,
          );
...
export function resQueue() {
  ...
  clearResDrag();
  $("#resQueue").attr("aria-busy", "true");
  clearElement($("#resQueue"));
  $("#resQueue").attr({
    role: "region",
    "aria-label": loc("research_queue"),
    "aria-live": "polite",
    "aria-atomic": "false",
  });
  $("#resQueue").append(
    $(`
        ...
        <span tabindex="0" id="pauserqueue" class="${global.r_queue.pause ? "pause" : "play"}" role="button" @click="pauseRQueue()" :aria-label="pausedesc()" :aria-pressed="pause"></span>
    `),
  );
  ...
  queue.append(
    $(
      `<li v-for="(item, index) in queue"><a v-bind:id="setID(index)" class="queued" v-bind:class="{ 'qany': item.qa }" @click="remove(index)" role="button"><span class="has-text-warning">{{ item.label }}</span> [<span v-bind:class="{ 'has-text-danger': item.cna, 'has-text-success': !item.cna && item.req, 'has-text-caution': !item.req && !item.cna }">{{ item.time | time }}</span><span class="is-sr-only" v-if="item.cna"> (${loc("insufficient")})</span><span class="is-sr-only" v-if="!item.req && !item.cna"> (${loc("missing_req")})</span>]</a></li>`,
    ),
  );
  ...
  try {
    vBind({
      ...
      methods: {
        remove(index) {
          let removed = global.r_queue.queue[index].label;
          clearPopper(`rq${global.r_queue.queue[index].id}`);
          global.r_queue.queue.splice(index, 1);
          resQueue();
          drawTech();
          messageQueue(
            `${removed} removed from research queue.`,
            "info",
            true,
        ...
        pauseRQueue() {
          ...
          if (global.r_queue.pause) {
            ...
            messageQueue("Research queue resumed.", "info", true, [
              "queue",
              "research_queue",
            ]);
          } else {
            ...
            messageQueue("Research queue paused.", "info", true, [
              "queue",
              "research_queue",
            ]);
          }
  ...
  Sortable.create(el, {
    onEnd(e) {
      ...
      order.splice(
        e.newDraggableIndex,
        0,
        order.splice(e.oldDraggableIndex, 1)[0],
      );
...
export function bank_vault() {
  ...
  if (global.tech.banking >= 7) {
    vault *=
      1 +
      highPopAdjust(workerScale(global.civic.banker.workers, "banker") * 0.05);
  }
