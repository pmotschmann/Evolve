        ...
        case 'assembly':
        {
            ...
            let action = {
                ...
                cost: {
                    ...
                    Aluminium(r={}){ return global.race['deconstructor'] ? 0 : global['resource'][global.race.species].amount >= 5 ? costMultiplier('citizen', r.offset, assemblyCostAdjust(50), 1.01) : 0; },
