    ...
    {   // Intro
        ...
        {   // Junk Gene
            ...
            neg_roll_traits.forEach(function (trait){
                traits.append(`${comma ? ', ' : ''}<a href="wiki.html#major_traits-species-major_${trait}" target="_blank" class="has-text-warning">${loc('trait_'+ trait + '_name')}</a>`);
                comma = true;
            });
        ...
        {   // Failed Experiment
            let failed = infoBoxBuilder(modes,{ name: 'modes_sludge', template: 'challenges', paragraphs: 7, break: [3,4,5,6,7], h_level: 2,
                ...
                data_link: {
                    ...
                    3: [false,false,'wiki.html#major_traits-species-major_ooze'],
        ...
        {   // Cataclysm
            let cataclysm = infoBoxBuilder(scenarios,{ name: 'scenarios_cataclysm', template: 'challenges', paragraphs: 9, break: [4,5,6,8,9], h_level: 2,
                ...
                data_link: {
                    ...
                    7: ['wiki.html#major_traits-species-major_parasite'],
