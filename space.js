...
const spaceProjects = {
    spc_home: {
        ...
        satellite: {
            ...
            effect: `<div>${loc('plus_max_resource',[750,loc('resource_Knowledge_name')])}</div><div>${loc('space_project_home_satellite_effect2')}</div><div>${loc('space_project_home_satellite_effect3')}</div>`,
            action(){
    ...
    spc_moon: {
        ...
        moon_mission: {
            ...
            title: loc('space_project_moon_mission_title'),
        ...
        moon_base: {
            ...
            effect(){
                ...
                return `<div>${loc('space_project_moon_base_effect1')}</div><div>${loc('plus_max_resource',[iridium,loc('resource_Iridium_name')])}</div><div>${loc('space_project_moon_base_effect3',[oil,spaceProjects.spc_moon.moon_base.powered])}</div>`;
            },
            support: 2,
            powered: 4,
            refresh: true,
        ...
        helium_mine: {
            ...
            effect(){
                ...
                return `<div>${loc('space_project_moon_helium_mine_effect1')}</div><div>${loc('space_project_moon_helium_mine_effect2')}</div><div>${loc('plus_max_resource',[storage,loc('resource_Helium_3_name')])}</div>`;
            },
            support: -1,
            powered: 1,
            action(){
        ...
        observatory: {
            ...
            effect(){
                return `<div>${loc('space_project_moon_observatory_effect1')}</div><div>${loc('plus_max_resource',[5000,loc('resource_Knowledge_name')])}<</div><div>${loc('space_project_moon_observatory_effect3')}<</div>`;
            },
            support: -1,
            powered: 1,
            action(){
    ...
    spc_red: {
        ...
        red_mission: {
            ...
            title(){
                return loc('space_project_mission_title',[races[global.race.species].solar.red]);
            },
            desc(){
                return loc('space_project_mission_desc',[races[global.race.species].solar.red]);
            },
        ...
        living_quarters: {
            ...
            effect(){
                return `<div>${loc('space_project_red_living_quarters_effect1',[races[global.race.species].solar.red])}</div><div>${loc('plus_max_resource',[1,loc('colonist')])}</div><div>${loc('plus_max_resource',[1,loc('citizen')])}</div>`;
            },
            support: -1,
            powered: 1,
            action(){
        ...
        exotic_lab: {
            ...
            effect(){
                ...
                return `<div>${loc('space_project_red_exotic_lab_effect1',[races[global.race.species].solar.red])}</div><div>${loc('space_project_red_exotic_lab_effect2')}</div><div>${loc('plus_max_resource',[elerium,loc('resource_Elerium_name')])}</div>`;
            },
            support: -1,
            powered: 1,
            refresh: true,
        ...
        space_barracks: {
            ...
            effect(){
                let oil = +fuel_adjust(2).toFixed(2);
                return `<div>${loc('plus_max_resource',[2,loc('soldier')])}</div><div>${loc('space_project_red_space_barracks_effect2',[oil])}</div><div>${loc('space_project_red_space_barracks_effect3')}</div>`;
            },
            powered: 1,
            action(){
    ...
    spc_hell: {
        ...
        hell_mission: {
            ...
            title(){
                return loc('space_project_mission_title',[races[global.race.species].solar.hell]);
            },
            desc(){
                return loc('space_project_mission_desc',[races[global.race.species].solar.hell]);
            },
            reqs: { space: 3, space_explore: 3 },
            grant: ['hell',1],
            cost: { 
            ...
            action(){
                if (payCosts(spaceProjects.spc_hell.hell_mission.cost)){
                    messageQueue(loc('space_project_hell_mission_action',[races[global.race.species].solar.hell]),'success');
    ...
    spc_gas: {
        ...
        gas_mission: {
            ...
            title(){
                return loc('space_project_mission_title',races[global.race.species].solar.gas);
            },
            desc(){
                return loc('space_project_mission_desc',races[global.race.species].solar.gas);
            },
    ...
    spc_gas_moon: {
        ...
        gas_moon_mission: {
            ...
            title(){
                return loc('space_project_mission_title',[races[global.race.species].solar.gas_moon]);
            },
            desc(){
                return loc('space_project_mission_desc',[races[global.race.species].solar.gas_moon]);
            },
            reqs: { space: 5 },
            grant: ['space',6],
            cost: { 
        ...
        outpost: {
            ...
            effect(){
                ...
                let oil = +(fuel_adjust(2)).toFixed(2);
                return `<div>${loc('space_project_gas_moon_outpost_effect1',[neutronium])}</div><div>${loc('plus_max_resource',[max,loc('resource_Neutronium_name')])}</div><div>${loc('space_project_gas_moon_outpost_effect3',[oil,spaceProjects.spc_gas_moon.outpost.powered])}</div>`;
            },
            powered: 3,
            action(){
    ...
    spc_belt: {
        ...
        space_station: {
            ...
            effect(){
                ...
                return `<div>${loc('plus_max_resource',[3,loc('space_miner')])}</div>${elerium}<div>${loc('space_project_belt_station_effect3',[helium])}</div><div>${loc('space_project_belt_station_effect4',[food,spaceProjects.spc_belt.space_station.powered])}</div>`;
            },
            support: 3,
            powered: 3,
            refresh: true,
    ...
    spc_dwarf: {
        ...
        dwarf_mission: {
            ...
            title(){
                return loc('space_project_mission_title',[races[global.race.species].solar.dwarf]);
            },
            desc(){
                return loc('space_project_mission_desc',[races[global.race.species].solar.dwarf]);
            },
        ...
        elerium_contain: {
            ...
            effect(){
                ...
                return `<div>${loc('plus_max_resource',[elerium,loc('resource_Elerium_name')])}</div><div>${loc('space_project_dwarf_elerium_contain_effect2',[spaceProjects.spc_dwarf.elerium_contain.powered])}</div>`;
            },
            powered: 6,
            action(){
        ...
        world_controller: {
            ...
            cost: {},
            effect(){
                return `<div>${loc('space_project_dwarf_controller_effect1')}</div><div>${loc('plus_max_resource',['25%',loc('resource_Knowledge_name')])}</div><div>${loc('space_project_dwarf_controller_effect3')}</div><div>${loc('space_project_dwarf_controller_effect4',[spaceProjects.spc_dwarf.world_controller.powered])}</div>`;
            },
            powered: 20,
            action(){
                return false;
