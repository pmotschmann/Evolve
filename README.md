...
## Build Commands
Assuming you configured your build environment correctly the game can be built and launched using
```
# Builds everything
npm run build
...
It may also be deployed on github-pages via the Deploy Website action, in the Actions tab of the github repository.
